...
$result = $adb->pquery("SELECT email1,user_hash,user_name
...
if ($adb->num_rows($result) > 0) {
	...
	$hash=$adb->query_result($result,0,'user_hash');
...
<h1>Dear Customer,</h1>
<p>You recently requested to reset your password for your coreBOS account. Use the button below to reset it. <strong>This password reset is only valid for the next 30 minutes.</strong><br><br> Regards,<br>
coreBOS Support Team.<br></p>
<!-- Action -->
...
<tr>
<td>
<a href="'.$trackURL.'" class="button " target="_blank">Reset your password</a>
</td>
</tr>
</table>
</td>
...
<tr>
<td>
<p >If you did not request a change of password, please ignore this e-mail</p>
</td>
</tr>
</table>
</td>
...
<p class="sub align-center">&copy; 2018 coreBOS CRM. All rights reserved.</p>
...
coreBOS_Session::set('success_message', $success_message);
...
{
	$errstr="No user found with this username ";
