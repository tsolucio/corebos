...
$this->ExecuteQuery("ALTER TABLE  its4you_googlesync4you_access ADD  refresh_token VARCHAR( 250 ) NOT NULL,ADD  synctoken VARCHAR( 250 ) NOT NULL ,ADD  googleinsert VARCHAR( 10 ) NOT NULL ");
