...
class addlinksforcalendar extends cbupdaterWorker {
	public function applyChange() {
		...
		if ($this->isApplied()) {
			...
			Vtiger_Link::addlink($tabid, 'HEADERSCRIPT', 'Calendar4You_HeaderScript3', 'modules/Calendar4You/fullcalendar/lib/moment.min.js', '', 1, null, true);
			Vtiger_Link::addlink($tabid, 'HEADERCSS', 'Calendar4You_HeaderStyle2', 'modules/Calendar4You/fullcalendar/themes/cupertino/jquery-ui.min.css', '', 1, null, true);
