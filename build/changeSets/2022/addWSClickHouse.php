...
class addWSClickHouse extends cbupdaterWorker {
	...
	public function applyChange() {
		...
		if ($this->isApplied()) {
			...
			$this->ExecuteQuery("INSERT INTO `vtiger_ws_entity` (`id`, `name`, `handler_path`, `handler_class`, `ismodule`)
				VALUES (?, 'ClickHouse', 'include/Webservices/VtigerClickHouseOperation.php', 'VtigerClickHouseOperation', '0')", array($wsid));
