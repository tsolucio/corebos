		...
		if ($this->isApplied()) {
			...
			if ($this->isModuleInstalled($module_name)) {
				...
				$focusnew->column_fields['content'] = "<map>
					...
					<Orgfields>
					<Orgfield>
					<OrgfieldName> concat('{\"title\":\"',productname,'\",\"body_html\":\"',description,'\",\"vendor\":\"',vendor_id,'\",\"product_type\":\"',productcategory,'\"}')</OrgfieldName><OrgfieldID>expression</OrgfieldID>
					<OrgfieldID>expression</OrgfieldID>
