...
class addNewFields2SMSqueueTable extends cbupdaterWorker {
	...
	public function applyChange() {
		...
		if ($this->isApplied()) {
			...
			global $adb;
			$this->ExecuteQuery("ALTER TABLE `cb_messagequeue` ADD `SMS_sendtime_start` DATE NULL DEFAULT NULL;");
			$this->ExecuteQuery("ALTER TABLE `cb_messagequeue` ADD `SMS_sendtime_end` DATE NULL DEFAULT NULL;");
