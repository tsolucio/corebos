...
class addGenerateDocumentTaskType extends cbupdaterWorker {
	...
	public function applyChange() {
		...
		if ($this->isApplied()) {
			...
			$taskType= array(
				...
				'classpath'=>'modules/com_vtiger_workflow/tasks/GenerateDocument.inc',
				'templatepath'=>'com_vtiger_workflow/taskforms/GenerateDocument.tpl',
	...
	public function isApplied() {
		...
		if (!$done) {
			global $adb;
			$result = $adb->pquery("SELECT * FROM com_vtiger_workflow_tasktypes where tasktypename='GenerateDocument'", array());
