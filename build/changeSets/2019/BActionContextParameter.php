...
class BActionContextParameter extends cbupdaterWorker {
	...
	public function applyChange() {
		...
		if ($this->isApplied()) {
			...
			global $adb;
			$result = $adb->pquery('SELECT operationid FROM vtiger_ws_operation WHERE name = ?', array('executeBusinessAction'));
			if ($result) {
