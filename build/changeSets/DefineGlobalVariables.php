	...
	public function applyChange() {
		...
		if ($this->isApplied()) {
			...
			$global_variables = array(
				...
				'Debug_Send_WebService_Error',
				'Debug_WebService_Errors',
				...
				'Application_Global_Search_Action',
				'Application_Global_Search_PlaceHolder',
				...
				'Application_DetailView_ActionPanel_CenteredActions',
				...
				'Application_ListView_Layout',
				'Application_ListView_MaxColumns',
				'Application_ListView_Max_Text_Length',
				'Application_ListView_Mass_Edit_Show',
				'Application_ListView_Mass_Delete_Show',
				...
				'HomePage_KeyMetrics_Max_Text_Length',
				'Zero_Bounce_API_KEY',
