...
class addModuleBuilderTables extends cbupdaterWorker {
	...
	public function applyChange() {
		...
		if ($this->isApplied()) {
			...
			$this->ExecuteQuery(
				'ALTER TABLE `vtiger_modulebuilder_relatedlists` ADD PRIMARY KEY (`relatedlistid`)'
			);
			$this->ExecuteQuery(
			...
			$this->ExecuteQuery(
				'ALTER TABLE `vtiger_modulebuilder_name` MODIFY `moduleid` int(20) NOT NULL AUTO_INCREMENT'
			);
			$this->ExecuteQuery(
				'ALTER TABLE `vtiger_modulebuilder_actions` MODIFY `actionsid` int(20) NOT NULL AUTO_INCREMENT'
			);
			$this->ExecuteQuery(
				'ALTER TABLE `vtiger_modulebuilder` MODIFY `modulebuilderid` int(20) NOT NULL AUTO_INCREMENT'
			);
			$this->ExecuteQuery(
				'ALTER TABLE `vtiger_modulebuilder_blocks` MODIFY `blocksid` int(20) NOT NULL AUTO_INCREMENT'
			);
			$this->ExecuteQuery(
				'ALTER TABLE `vtiger_modulebuilder_customview` MODIFY `customviewid` int(20) NOT NULL AUTO_INCREMENT'
			);
			$this->ExecuteQuery(
				'ALTER TABLE `vtiger_modulebuilder_fields` MODIFY `fieldsid` int(20) NOT NULL AUTO_INCREMENT'
			);
			$this->ExecuteQuery(
				'ALTER TABLE `vtiger_modulebuilder_relatedlists` MODIFY `relatedlistid` int(20) NOT NULL AUTO_INCREMENT'
			);
