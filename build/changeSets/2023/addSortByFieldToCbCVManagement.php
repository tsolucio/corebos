...
class addSortByFieldToCbCVManagement extends cbupdaterWorker {
			...
			$fields = array(
				'cbCVManagement' => array(
					'LBL_CVMGMT_DEFAULTS' => array(
						'sortfieldbyfirst' => array(
							'columntype'=>'varchar(50)',
							'typeofdata'=>'V~O',
							'uitype'=>1,
							'label' => 'sort field by second'
						),
						'sortfieldbysecond' => array(
							'columntype'=>'varchar(50)',
							'typeofdata'=>'V~O',
							'uitype'=>1,
							'label' => 'sort field by first'
						),
					),
				),
			);
