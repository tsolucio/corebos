// must define the variable i18nLanguage with the language before loading the script
/*
...
const i18nMessages = {
	en: {
		grabTitle: "Change tool to grab",
		lineTitle: "Change tool to line",
		brushTitle: "Change tool to brush",
		textTitle: "Change tool to text",
		pickerTitle: "Change tool to picker",
		selectTitle: "Change tool to select",
		undoTitle: "Undo drawing",
		blockTitle: "Change tool to block",
		toolSizetext: "Tool size",
		toolSizeTitle: "Change the size of the tool",
		zoomTitle: "Change tool to zoom",
		zoomInTitle: "Zoom in",
		zoomResetTitle: "Reset zoom",
		zoomOutTitle: "Zoom out",
		toolColorText: "Tool color",
		toolColorTitle: "Change the color of the tool",
		randomAlt: "Jump to random location",
		randomTitle: "Jump to random location",
		randomDataIntro: "Since you are new, you are restricted on where you can draw. Use this button to find a spot.",
		cancelText: "cancel",
		chooseText: "choose",
	...
	es: {
		...
		brushTitle: "Pincel",
		textTitle: "Texto",
		pickerTitle: "Absorber Color",
		selectTitle: "Seleccionar",
		undoTitle: "Deshacer",
		blockTitle: "Bloque",
		toolSizeText: "Cambiar tamaño pincel",
		toolSizeTitle: "Tamaño",
		zoomTitle: "Zoom",
		zoomInTitle: "Zoom acercar",
		zoomResetTitle: "Zoom base",
		zoomOutTitle: "Zoom alejar",
		toolColorText: "Cambiar el Color",
		toolColorTitle: "Color",
		randomAlt: "Mover a cualquier sitio",
		randomTitle: "Mover a cualquier sitio",
		randomDataIntro: "Como eres nuevo, tienes restricciones sobre dónde puedes dibujar. Utiliza este botón para encontrar un lugar.",
		cancelText: "cancela",
		chooseText: "elige",
		togglePaletteMoreText: "más",
		togglePaletteLessText: "menos",
		clearText: "Limpiar Selección de Color",
...
(function (root, factory) {
  ...
  function IntroJs(obj) {
    ...
    this._options = {
      ...
      nextLabel: i18nMessages[i18nLanguage].nextLabel+' &rarr;',
      /* Previous button label in tooltip box */
      prevLabel: '&larr; '+i18nMessages[i18nLanguage].prevLabel,
      /* Skip button label in tooltip box */
      skipLabel: i18nMessages[i18nLanguage].skipLabel,
      /* Done button label in tooltip box */
      doneLabel: i18nMessages[i18nLanguage].doneLabel,
...
(function (factory) {
    ...
    var defaultOpts = {
        ...
        appendTo: "body",
        maxSelectionSize: 7,
        cancelText: i18nMessages[i18nLanguage].cancelText,
        chooseText: i18nMessages[i18nLanguage].chooseText,
        togglePaletteMoreText: i18nMessages[i18nLanguage].togglePaletteMoreText,
        togglePaletteLessText: i18nMessages[i18nLanguage].togglePaletteLessText,
        clearText: i18nMessages[i18nLanguage].clearText,
        noColorSelectedText: i18nMessages[i18nLanguage].noColorSelectedText,
...
Paint.prototype.addCoordDom = function addCoordDom (container) {
	...
	randomButtonImage.alt = i18nMessages[i18nLanguage].randomAlt;
	randomButtonImage.title = i18nMessages[i18nLanguage].randomTitle;
	randomButton.setAttribute("data-intro", i18nMessages[i18nLanguage].randomDataIntro);
...
Paint.prototype.createControlArray = function createControlArray () {
	return [{
		...
		title: i18nMessages[i18nLanguage].grabTitle,
		value: "grab",
		...
		title: i18nMessages[i18nLanguage].lineTitle,
		value: "line",
		action: this.changeTool.bind(this)
	}, {
		name: "brush",
		...
		title: i18nMessages[i18nLanguage].brushTitle,
		value: "brush",
		action: this.changeTool.bind(this)
	}, {
		name: "text",
		...
		title: i18nMessages[i18nLanguage].textTitle,
		value: "text",
		action: this.changeTool.bind(this)
	}, {
		name: "picker",
		...
		title: i18nMessages[i18nLanguage].pickerTitle,
		value: "picker",
		action: this.changeTool.bind(this)
	}, {
		name: "zoom",
		...
		title: i18nMessages[i18nLanguage].zoomTitle,
		value: "zoom",
		action: this.changeTool.bind(this)
	}, {
		name: "select",
		...
		title: i18nMessages[i18nLanguage].selectTitle,
		value: "select",
		action: this.changeTool.bind(this)
	}, {
		name: "undo",
		...
		title: i18nMessages[i18nLanguage].undoTitle,
		action: this.undo.bind(this)
	}, /*{
		name: "block",
		type: "button",
		image: "images/icons/block.png",
		title: i18nMessages[i18nLanguage].blockTitle,
		value: "block",
		action: this.changeTool.bind(this)
	},*/ {
		name: "tool-size",
		type: "integer",
		range: true,
		text: i18nMessages[i18nLanguage].toolSizeText,
		min: 1,
		max: this.defaultSettings.maxSize,
		value: 5,
		title: i18nMessages[i18nLanguage].toolSizeTitle,
		action: this.changeToolSize.bind(this)
	}, {
		name: "zoom-in",
		type: "button",
		image: "include/components/PaintJS/images/zoomin.png",
		title: i18nMessages[i18nLanguage].zoomInTitle,
		value: 1.2,
		...
		title: i18nMessages[i18nLanguage].zoomResetTitle,
		value: 1,
		...
		title: i18nMessages[i18nLanguage].zoomOutTitle,
		value: 1 / 1.2,
		action: this.zoom.bind(this)
	}, {
		name: "tool-color",
		type: "color",
		text: i18nMessages[i18nLanguage].toolColorText,
		value: "#FFFFFF",
		title: i18nMessages[i18nLanguage].toolColorTitle,
