...
var alert_arr = {
	'DELETE':'¿Borrar los ',
	'RECORDS':' registros?',
	'SELECT':'Introduce, al menos, una entidad',
	'SELECTCONDITION':'Introduce, al menos, una condición',
	...
	'SELECT_MAILID':'Selecciona un Email Id',
	...
	'ENTER_VALID':'Selecciona un válido ',
	...
	'SELECT_ATLEAST_ONE_USER':'Selecciona, al menos, un usuario',
	...
	'SELECT_ATLEAST_ONEMSG_TO_DEL':'Selecciona, al menos, un email para borrar',
	'ERROR':'Error',
	...
	'VALID_FINAL_PERCENT':'Introduce un Porcentaje de Descuento válido',
	'VALID_FINAL_AMOUNT':'Introduce un Importe Final válido',
	'VALID_SHIPPING_CHARGE':'Introduce un Cargo por Manipulado y Transporte válido',
	'VALID_ADJUSTMENT':'Introduce un ajuste válido',
	'WANT_TO_CONTINUE':'¿Quiere continuar?',
	'ENTER_VALID_TAX':'Introduce un Valor de Impuesto válido',
	'VALID_TAX_NAME':'Introduce un Nombre de Impuesto válido',
	'CORRECT_TAX_VALUE':'Introduce un Valor de Impuesto correcto',
	'ENTER_POSITIVE_VALUE':'Introduce un Valor positivo',
	'LABEL_SHOULDNOT_EMPTY':'El nombre del Impuesto no puede estar vacío',
	'NOT_VALID_ENTRY':'no es una entrada válida. Introduce un valor correcto.',
	'VALID_DISCOUNT_PERCENT':'Introduce un Porcentaje de Descuento válido',
	'VALID_DISCOUNT_AMOUNT':'Introduce un Importe de Descuento válido',
	'SELECT_TEMPLATE_TO_MERGE':'Selecciona una plantilla para combinar',
	...
	'PLS_SELECT_VALID_FILE':'Selecciona un archivo con las siguientes extensiones:\n',
	...
	'VALID_TAX_PERCENT':'Introduce un Porcentaje de Impuesto válido',
	'VALID_SH_TAX':'Introduce un Impuesto válido para Manipulación y Transportes',
	'ROLE_DRAG_ERR_MSG':'No puede mover un Nodo Padre bajo un Nodo Hijo',
	'LBL_DEL':'Supr',
	'VALID_DATA':' Introduce una fecha válida. ',
	...
	'LBL_AND':'y',
	'LBL_OR': 'o',
	'LBL_ENTER_VALID_PORT':'Introduce un número de puerto válido',
	'IN_USERNAME':' en Usuario ',
	'LBL_ENTER_VALID_NO':'Introduce un número',
	...
	'LBL_NOTSEARCH_WITHSEARCH_ALL':'No has usado la búsqueda. Todos los registros serán exportados desde ',
	'LBL_NOTSEARCH_WITHSEARCH_CURRENTPAGE':'No has buscado nada. Pero has seleccionado con una búsqueda y <br> página actual. Los registros de la página actual se<br> exportarán desde ',
	'LBL_NO_DATA_SELECTED':'No hay registros seleccionados. Selecciona, al menos, un registro a exportar',
	'LBL_SEARCH_WITHOUTSEARCH_ALL':'Has utilizado la opción de búsqueda, pero no has seleccionado "sin buscar" y todas las opciones.\n Puedes hacer clic en [Aceptar] para exportar todos los datos o puedes hacer clic en [Cancelar] y volver a intentarlo con otros criterios de exportación.',
	'STOCK_IS_NOT_ENOUGH':'No hay suficiente stock',
	'LBL_QTY_IN_STOCK' : 'Cantidad en stock',
	'INVALID_QTY':'Cantidad Inválida',
	'LBL_SEARCH_WITHOUTSEARCH_CURRENTPAGE':'Has utilizado la opción de búsqueda, pero no has seleccionado sin las opciones de búsqueda y página actual.\n Puedes hacer clic en [Aceptar] para exportar los datos de la página actual o puedes hacer clic en [Cancelar] e intentarlo de nuevo con otros criterios de exportación.',
	...
	'ERR_INVALID_MONTH' : ' Por favor, introduce un mes válido.',
	'ERR_INVALID_DAY' : 'Por favor, introduce un dia válido.',
	'ERR_INVALID_YEAR' : 'Por favor, introduce un año de 4 dígitos.',
	'ERR_INVALID_DATE' : 'Por favor, introduce una fecha válida',
	'ERR_INVALID_HOUR' : 'Por favor, introduce una hora válida',
	'ERR_INVALID_TIME' : 'Por favor, introduce un tiempo válido',
	...
	'JSLBL_DRAW': 'Dibujar',
	'JSLBL_DRAW_MODAL_TITLE': 'Error al dibujar',
	'JSLBL_DRAW_MODAL_MESSAGE': 'No tienes permiso para Dibujar/Editar',
	'JSLBL_LEFT': 'Izquierda',
	'JSLBL_RIGHT': 'Derecha',
	...
	'ERR_ENTER_OLD_PASSWORD': 'Por favor, introduce su contraseña actual.',
	'ERR_ENTER_NEW_PASSWORD': 'Por favor, introduce su nueva contraseña.',
	...
	'ACT_UNIT_PRICE_MISMATCH': 'El precio real de esta moneda debe ser igual al precio unitario, pero este no es el caso de este producto o servicio.',
	'LBL_SHOWING': 'Mostrando Registros ',
	'LBL_RECORDS': ' de ',
	'LNK_DELETE': 'borrar',
	'LNK_EDIT': 'editar',
	...
	'LBL_MATCH_ERROR': 'Solo puedes emparejar los campos que selecciones para mostrar',
	...
	'LBL_PREVIEW_MAIL': 'Visualizar Correo',
	'LBL_SEND_MAIL': 'Enviar Correo',
	'LBL_EXPAND_PANEL': 'Abrir Panel',
	'LBL_MIN_PANEL': 'Minimizar Panel',
	'LBL_DUPLICATE_PRODUCT': 'Por favor duplica el producto',
	'LBL_SELECT_MORE_ROWS': 'Por favor selecciona al menos una fila',
	'LBL_SELECT_ROW': 'Por favor selecciona una fila',
	'LBL_DELETE_SUCCESS': 'Eliminado correctamente',
	'LBL_WRONG': 'Ha sucedido un error. Intenta de nuevo!',
	'LBL_UNABLE_TO_FILTER': 'No se ha podido filtrar la información. Intenta de nuevo!',
	'LNK_DUPLICATE': 'Duplicar',
	...
	'LBL_CLEAR': 'Limpiar',
	'LBL_WF_Workflow': 'Workflow',
	'LBL_WF_Type': 'Type',
	'LBL_WF_Description': 'Description',
	'LBL_WF_Purpose': 'Purpose',
	'LBL_WF_Trigger': 'Trigger',
	'LBL_WF_Status': 'Status',
	'LBL_WF_Tools': 'Tools',
	'LBL_WF_AllModules': 'All Modules',
	'LBL_WF_ForModule': 'For Module',
	'LBL_WF_FromTemplate': 'From Template',
	'LBL_WF_NoTemplate': 'No Templates',
	'LBL_WF_ChooseTemplate': 'Choose a template',
	'LBL_WF_Total': 'Total',
	'LBL_WF_Active': 'Active',
	'LBL_WF_Inactive': 'Inactive',
	'LBL_WF_New': 'New Workflow',
	'LBL_WF_Deactivate': 'Deactivate',
	'LBL_WF_Activate': 'Activate',
	'LBL_WF_Redirect': 'Redirect',
	'LBL_WF_List': 'Workflow List',
};
