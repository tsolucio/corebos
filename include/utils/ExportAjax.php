...
if ($_REQUEST['export_record']) {
	...
	if ($_REQUEST['export_data'] == 'all' && $_SESSION['export_where'] == '') {
		echo 'NOT_SEARCH_WITHSEARCH_ALL';
		exit();
	} elseif ($_REQUEST['export_data'] == 'currentpage' && $_SESSION['export_where'] == '') {
		echo 'NOT_SEARCH_WITHSEARCH_CURRENTPAGE';
		exit();
	} elseif ($_REQUEST['export_data'] == 'selecteddata' && $idstring == '') {
		echo 'NO_DATA_SELECTED';
		exit();
	} elseif ($_REQUEST['export_data'] == 'all' && !empty($_SESSION['export_where'])) {
		echo 'SEARCH_WITHOUTSEARCH_ALL';
		exit();
	} elseif ($_REQUEST['export_data'] == 'currentpage' && !empty($_SESSION['export_where'])) {
