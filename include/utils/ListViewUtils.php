...
function getTableHeaderNavigation($navigation_array, $url_qry, $module = '', $action_val = 'index', $viewid = '') {
	...
	if (($navigation_array['prev']) != 0) {
		if ($module == 'Calendar' && $action_val == 'index') {
			...
			$output .= '<a href="javascript:;" onClick="cal_navigation(\'' . $tab_type . '\',\'' . $url_string . '\',\'&start=1\');" alt="' . $app_strings['LBL_FIRST'] . '" title="' . $app_strings['LBL_FIRST'] . '"><img src="' . vtiger_imageurl('start.gif', $theme) . '" border="0" style="-webkit-transform: rotate(180deg);transform: rotate(180deg);" align="absmiddle"></a>&nbsp;';
			...
			$output .= '<a href="javascript:;" onClick="cal_navigation(\'' . $tab_type . '\',\'' . $url_string . '\',\'&start=' . $navigation_array['prev'] . '\');" alt="' . $app_strings['LBL_FIRST'] . '" title="' . $app_strings['LBL_FIRST'] . '"><img src="' . vtiger_imageurl('start.gif', $theme) . '" border="0" style="-webkit-transform: rotate(180deg);transform: rotate(180deg);" align="absmiddle"></a>&nbsp;';
		} else if ($action_val == "FindDuplicate") {
			$output .= '<a href="javascript:;" onClick="getDuplicateListViewEntries_js(\'' . $module . '\',\'parenttab=' . $tabname . '&start=1' . $url_string . '\');" alt="' . $app_strings['LBL_FIRST'] . '" title="' . $app_strings['LBL_FIRST'] . '"><img src="' . vtiger_imageurl('start.gif', $theme) . '" border="0" style="-webkit-transform: rotate(180deg);transform: rotate(180deg);" align="absmiddle"></a>&nbsp;';
			...
			$output .= '<a href="javascript:;" onClick="getUnifiedSearchEntries_js(\'' . $search_tag . '\',\'' . $module . '\',\'parenttab=' . $tabname . '&start=1' . $url_string . '\');" alt="' . $app_strings['LBL_FIRST'] . '" title="' . $app_strings['LBL_FIRST'] . '"><img src="' . vtiger_imageurl('start.gif', $theme) . '" border="0" style="-webkit-transform: rotate(180deg);transform: rotate(180deg);" align="absmiddle"></a>&nbsp;';
			...
			$output .= '<a href="javascript:;" onClick="getListViewEntries_js(\'' . $module . '\',\'parenttab=' . $tabname . '&start=1' . $url_string . '\');" alt="' . $app_strings['LBL_FIRST'] . '" title="' . $app_strings['LBL_FIRST'] . '"><img src="' . vtiger_imageurl('start.gif', $theme) . '" border="0" style="-webkit-transform: rotate(180deg);transform: rotate(180deg);" align="absmiddle"></a>&nbsp;';
...
function getRelatedTableHeaderNavigation($navigation_array, $url_qry, $module, $related_module, $recordid) {
	...
	$output = '<td align="right" style="padding="5px;">';
	if (($navigation_array['prev']) != 0) {
		$output .= '<a href="javascript:;" onClick="loadRelatedListBlock(\'' . $urldata . '&relstart=1\',\'' . $target . '\',\'' . $imagesuffix . '\');" alt="' . $app_strings['LBL_FIRST'] . '" title="' . $app_strings['LBL_FIRST'] . '"><img src="' . vtiger_imageurl('start.gif', $theme) . '" border="0" style="-webkit-transform: rotate(180deg);transform: rotate(180deg);" align="absmiddle"></a>&nbsp;';
		...
		$output .= '<img src="' . vtiger_imageurl('start_disabled.gif', $theme) . '" border="0" class="disabled" style="-webkit-transform: rotate(180deg);transform: rotate(180deg);width:18px;" align="absmiddle">&nbsp;';
		$output .= '<img src="' . vtiger_imageurl('previous_disabled.gif', $theme) . '" border="0" class="disabled" style="width:18px;" align="absmiddle">&nbsp;';
	}
...
function getTableHeaderSimpleNavigation($navigation_array, $url_qry, $module = '', $action_val = 'index', $viewid = '') {
	...
	if (($navigation_array['next']) != 0) {
		...
		$output .= '<img src="' . vtiger_imageurl('next_disabled.gif', $theme) . '" align="absmiddle" class="disabled" style="width:18px;">&nbsp;';
		$output .= '<img src="' . vtiger_imageurl('end_disabled.gif', $theme) . '" align="absmiddle" class="disabled" style="width:18px;">&nbsp;';
	}
	$output .= '</td>';
	if ($navigation_array['first'] == '')
		return;
