...
/**
 * Function to exporting excel rows file format for modules.
 * Params $rowsonfo, $totalxclinfo, $fldname, $fieldinfo, $modulename
 * Return xls rows
 */
...
/**
 * This function dump all csv rows for a given module, fieldc columns and query result
 * Params $type, $__processor, $CSV_Separator, $columnsToExport, $result, $focus
 * Return rows of records
 */
...
/**
 * This function dump all xls rows for a given module, fieldc columns and query result
 * Params $type, $__processor, $columnsToExport, $translated_fields_array, $result
 * Return rows of records
 */
function dumpRowsToXLS($__processor = '', $columnsToExport, $translated_fields_array, $result) {
	global $adb;
