...
class WebServiceErrorCode {
	...
	public static $INVALIDUSER = 'INVALID_USER';
	...
	public static $INVALIDMODULE = 'INVALID_MODULE';
	...
	public static $UNKNOWNENTITY = 'UNKNOWN_ENTITY';
	public static $INVALID_POTENTIAL_FOR_CONVERT_LEAD = 'INVALID_POTENTIAL_FOR_CONVERTLEAD';
	public static $LEAD_CONVERTCONDITIONSNOTMET = 'LEAD_CONVERT_CONDITIONS_NOT_MET';
	...
	public static $INVALID_BUSINESSMAP = 'INVALID_BUSINESSMAP';
	public static $INVALID_PARAMETER = 'INVALID_PARAMETER';
	...
	public static $INVALIDFILECONTENTS = 'INVALID_FILE_CONTENTS';
}
?>
