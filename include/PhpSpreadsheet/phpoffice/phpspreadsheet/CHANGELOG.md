...
- Extracted coordinate method to dedicate class [migration guide](./docs/topics/migration-from-\PhpOffice\PhpSpreadsheet\Spreadsheet.md).
- Column indexes are based on 1, see the [migration guide](./docs/topics/migration-from-\PhpOffice\PhpSpreadsheet\Spreadsheet.md).
- Standardization of array keys used for style, see the [migration guide](./docs/topics/migration-from-\PhpOffice\PhpSpreadsheet\Spreadsheet.md).
- Easier usage of PDF writers, and other custom readers and writers, see the [migration guide](./docs/topics/migration-from-\PhpOffice\PhpSpreadsheet\Spreadsheet.md).
- Easier usage of chart renderers, see the [migration guide](./docs/topics/migration-from-\PhpOffice\PhpSpreadsheet\Spreadsheet.md).
...
- MemoryDrawing not working in HTML writer [#808](https://github.com/PHPOffice/\PhpOffice\PhpSpreadsheet\Spreadsheet/issues/808)
...
- Ignore inlineStr type if formula element exists - @ncrypthic [#570](https://github.com/PHPOffice/\PhpOffice\PhpSpreadsheet\Spreadsheet/issues/570)
- Excel 2007 Reader freezes because of conditional formatting - @rentalhost [#575](https://github.com/PHPOffice/\PhpOffice\PhpSpreadsheet\Spreadsheet/issues/575)
...
- Whitespace after toRichTextObject() - @MarkBaker [#554](https://github.com/PHPOffice/\PhpOffice\PhpSpreadsheet\Spreadsheet/issues/554)
- Optimize vlookup() sort - @umpirsky [#548](https://github.com/PHPOffice/\PhpOffice\PhpSpreadsheet\Spreadsheet/issues/548)
- c:max and c:min elements shall NOT be inside c:orientation elements - @vitalyrepin [#869](https://github.com/PHPOffice/\PhpOffice\PhpSpreadsheet\Spreadsheet/pull/869)
- Implement actual timezone adjustment into \PhpOffice\PhpSpreadsheet\Shared\Date::PHPToExcel - @sim642 [#489](https://github.com/PHPOffice/\PhpOffice\PhpSpreadsheet\Spreadsheet/pull/489)

### BREAKING CHANGE

- Introduction of namespaces for all classes, eg: `\PhpOffice\PhpSpreadsheet\Calculation\Functions` becomes `PhpOffice\PhpSpreadsheet\Calculation\Functions`
- Some classes were renamed for clarity and/or consistency:

For a comprehensive list of all class changes, and a semi-automated migration path, read the [migration guide](./docs/topics/migration-from-\PhpOffice\PhpSpreadsheet\Spreadsheet.md).

- Dropped `\PhpOffice\PhpSpreadsheet\Calculation\Functions::VERSION()`. Composer or git should be used to know the version.
- Dropped `\PhpOffice\PhpSpreadsheet\Settings::setPdfRenderer()` and `\PhpOffice\PhpSpreadsheet\Settings::setPdfRenderer()`. Composer should be used to autoload PDF libs.
- Dropped support for HHVM

## Previous versions of \PhpOffice\PhpSpreadsheet\Spreadsheet

The changelog for the project when it was called \PhpOffice\PhpSpreadsheet\Spreadsheet is [still available](./CHANGELOG.\PhpOffice\PhpSpreadsheet\Spreadsheet.md).
