# Changelog for \PhpOffice\PhpSpreadsheet\Spreadsheet
...
- Passing an array of cells to _generateRow() in the HTML/PDF Writer causes caching problems with last cell in the range - @MarkBaker [#257](https://github.com/PHPOffice/\PhpOffice\PhpSpreadsheet\Spreadsheet/issues/257)
...
- Convert properties to string in OOCalc reader - @infojunkie [#276](https://github.com/PHPOffice/\PhpOffice\PhpSpreadsheet\Spreadsheet/issues/276)
...
- Support for Rich-Text in \PhpOffice\PhpSpreadsheet\Writer\Xls - @Progi1984 [CodePlex #8916](https://phpexcel.codeplex.com/workitem/8916)
...
- Fractions stored as text are not treated as numbers by \PhpOffice\PhpSpreadsheet\Spreadsheet's calculation engine - @MarkBaker [CodePlex #10490](https://phpexcel.codeplex.com/workitem/10490)
...
- \PhpOffice\PhpSpreadsheet\Writer\Xls improvements writing shared strings table - @Erik Tilt [CodePlex #9194](https://phpexcel.codeplex.com/workitem/9194)
- \PhpOffice\PhpSpreadsheet\Writer\Xls iconv fallback when mbstring extension is not enabled - @Erik Tilt [CodePlex #9248](https://phpexcel.codeplex.com/workitem/9248)
- UTF-8 support in font names in \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #9253](https://phpexcel.codeplex.com/workitem/9253)
...
- Eliminate duplicate style entries in multisheet workbook written by \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #9355](https://phpexcel.codeplex.com/workitem/9355)
...
- Spurious column dimension element introduced in blank worksheet after using \PhpOffice\PhpSpreadsheet\Writer\Xlsx - @MarkBaker [CodePlex #8816](https://phpexcel.codeplex.com/workitem/8816)
- Image gets slightly narrower than expected when using \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #8830](https://phpexcel.codeplex.com/workitem/8830)
- Image laid over non-visible row gets squeezed in height when using \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #8831](https://phpexcel.codeplex.com/workitem/8831)
- \PhpOffice\PhpSpreadsheet\Reader\Xls fails when there are 10 or more images in the workbook - @Erik Tilt [CodePlex #8860](https://phpexcel.codeplex.com/workitem/8860)
- Different header/footer images in different sheets not working with \PhpOffice\PhpSpreadsheet\Writer\Xlsx - @MarkBaker [CodePlex #8909](https://phpexcel.codeplex.com/workitem/8909)
- Fractional seconds disappear when using \PhpOffice\PhpSpreadsheet\Reader\Xlsx and \PhpOffice\PhpSpreadsheet\Reader\Xls - @MB, ET [CodePlex #8924](https://phpexcel.codeplex.com/workitem/8924)
- Images not showing in OpenOffice when using \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #7994](https://phpexcel.codeplex.com/workitem/7994)
- Images not showing on print using \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #9047](https://phpexcel.codeplex.com/workitem/9047)
- \PhpOffice\PhpSpreadsheet\Writer\Xls maximum allowed record size 4 bytes too short - @Erik Tilt [CodePlex #9085](https://phpexcel.codeplex.com/workitem/9085)
...
- \PhpOffice\PhpSpreadsheet\Reader\Xls reader fails with fatal error when reading group shapes - @Erik Tilt [CodePlex #9203](https://phpexcel.codeplex.com/workitem/9203)
- \PhpOffice\PhpSpreadsheet\Writer\Xls fails completely when workbook contains more than 57 colors - @Erik Tilt [CodePlex #9231](https://phpexcel.codeplex.com/workitem/9231)
- \PhpOffice\PhpSpreadsheet\Writer\Pdf not compatible with autoload - @Erik Tilt [CodePlex #9244](https://phpexcel.codeplex.com/workitem/9244)
- Fatal error: Call to a member function getNestingLevel() on a non-object in \PhpOffice\PhpSpreadsheet\Spreadsheet/Reader/Excel5.php on line 690 - @Erik Tilt [CodePlex #9250](https://phpexcel.codeplex.com/workitem/9250)
...
- Column greater than 256 results in corrupt Excel file using \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt
...
- Call to undefined method \PhpOffice\PhpSpreadsheet\Worksheet\MemoryDrawing::getPath() in \PhpOffice\PhpSpreadsheet\Spreadsheet/Writer/HTML.php - @Erik Tilt [CodePlex #9372](https://phpexcel.codeplex.com/workitem/9372)
...
- \PhpOffice\PhpSpreadsheet\Writer\Html validation errors against strict HTML 4.01 / CSS 2.1 - @Erik Tilt
...
- \PhpOffice\PhpSpreadsheet\Reader\Xls support for print gridlines - @Erik Tilt [CodePlex #7897](https://phpexcel.codeplex.com/workitem/7897)
...
- \PhpOffice\PhpSpreadsheet\Reader\Xls style support for BIFF5 files (Excel 5.0 - Excel 95) - @Erik Tilt [CodePlex #7862](https://phpexcel.codeplex.com/workitem/7862)
- \PhpOffice\PhpSpreadsheet\Reader\Xls support for user-defined colors and special built-in colors - @Erik Tilt [CodePlex #7918](https://phpexcel.codeplex.com/workitem/7918)
- Support for freeze panes in \PhpOffice\PhpSpreadsheet\Reader\Xls - @Erik Tilt [CodePlex #7992](https://phpexcel.codeplex.com/workitem/7992)
- Support for header and footer margins in \PhpOffice\PhpSpreadsheet\Reader\Xls - @Erik Tilt [CodePlex #7996](https://phpexcel.codeplex.com/workitem/7996)
- Support for active sheet index in Excel5 reader/writer - @Erik Tilt [CodePlex #7997](https://phpexcel.codeplex.com/workitem/7997)
- Freeze panes not read by \PhpOffice\PhpSpreadsheet\Reader\Xlsx - @MarkBaker [CodePlex #7991](https://phpexcel.codeplex.com/workitem/7991)
- Support for screen zoom level (feature request) - @MB, ET [CodePlex #7993](https://phpexcel.codeplex.com/workitem/7993)
- Support for default style in \PhpOffice\PhpSpreadsheet\Reader\Xls - @Erik Tilt [CodePlex #8012](https://phpexcel.codeplex.com/workitem/8012)
...
- Improve method for storing MERGEDCELLS records in \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #8418](https://phpexcel.codeplex.com/workitem/8418)
- Support for protectCells() in Excel5 reader/writer - @Erik Tilt [CodePlex #8435](https://phpexcel.codeplex.com/workitem/8435)
- Support for fitToWidth and fitToHeight pagesetup properties in \PhpOffice\PhpSpreadsheet\Reader\Xls - @Erik Tilt [CodePlex #8472](https://phpexcel.codeplex.com/workitem/8472)
- Support for setShowSummaryBelow() and setShowSummaryRight() in \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #8489](https://phpexcel.codeplex.com/workitem/8489)
...
- setPrintGridlines(true) not working with \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #7896](https://phpexcel.codeplex.com/workitem/7896)
- Incorrect mapping of fill patterns in \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #7907](https://phpexcel.codeplex.com/workitem/7907)
- setShowGridlines(false) not working with \PhpOffice\PhpSpreadsheet\Writer\Xlsx - @MarkBaker [CodePlex #7898](https://phpexcel.codeplex.com/workitem/7898)
- getShowGridlines() gives inverted value when reading sheet with \PhpOffice\PhpSpreadsheet\Reader\Xlsx - @MarkBaker [CodePlex #7905](https://phpexcel.codeplex.com/workitem/7905)
...
- Incomplete border style support in \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #7949](https://phpexcel.codeplex.com/workitem/7949)
...
- All sheets are always selected in output when using \PhpOffice\PhpSpreadsheet\Writer\Xlsx - @MarkBaker [CodePlex #7995](https://phpexcel.codeplex.com/workitem/7995)
...
- MS Outlook corrupts files generated by \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #8320](https://phpexcel.codeplex.com/workitem/8320)
- Undefined method \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::setFreezePane() in ReferenceHelper.php on line 271 - @MarkBaker [CodePlex #8351](https://phpexcel.codeplex.com/workitem/8351)
- Ampersands (&), left and right angles (<, >) in Rich-Text strings leads to corrupt output using \PhpOffice\PhpSpreadsheet\Writer\Xlsx - @MarkBaker [CodePlex #8401](https://phpexcel.codeplex.com/workitem/8401)
- Print header and footer not supporting UTF-8 in \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #8408](https://phpexcel.codeplex.com/workitem/8408)
- Vertical page breaks not working with \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #8463](https://phpexcel.codeplex.com/workitem/8463)
- Missing support for accounting underline types in \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #8476](https://phpexcel.codeplex.com/workitem/8476)
- Infinite loops when reading corrupt xls file using \PhpOffice\PhpSpreadsheet\Reader\Xls - @Erik Tilt [CodePlex #8482](https://phpexcel.codeplex.com/workitem/8482)
- Sheet protection password not working with \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #8566](https://phpexcel.codeplex.com/workitem/8566)
- \PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_NUMBER ignored by \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #8596](https://phpexcel.codeplex.com/workitem/8596)
- \PhpOffice\PhpSpreadsheet\Reader\Xls fails a whole when workbook contains a chart - @Erik Tilt [CodePlex #8781](https://phpexcel.codeplex.com/workitem/8781)
- Occasional loss of column widths using \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #8788](https://phpexcel.codeplex.com/workitem/8788)
- Notices while reading formulas with deleted sheet references using \PhpOffice\PhpSpreadsheet\Reader\Xls - @Erik Tilt [CodePlex #8795](https://phpexcel.codeplex.com/workitem/8795)
- Default style not read by \PhpOffice\PhpSpreadsheet\Reader\Xlsx - @MarkBaker [CodePlex #8807](https://phpexcel.codeplex.com/workitem/8807)
- Blank rows occupy too much space in file generated by \PhpOffice\PhpSpreadsheet\Writer\Xlsx - @MarkBaker [CodePlex #9341](https://phpexcel.codeplex.com/workitem/9341)
...
- Improve speed and memory consumption of \PhpOffice\PhpSpreadsheet\Writer\Csv - @MarkBaker [CodePlex #7445](https://phpexcel.codeplex.com/workitem/7445)
...
- \PhpOffice\PhpSpreadsheet\Reader\Xls support for page breaks - @Erik Tilt [CodePlex #7607](https://phpexcel.codeplex.com/workitem/7607)
- \PhpOffice\PhpSpreadsheet\Reader\Xls support for shrink-to-fit - @Erik Tilt [CodePlex #7622](https://phpexcel.codeplex.com/workitem/7622)
...
- Support for named ranges (defined names) in \PhpOffice\PhpSpreadsheet\Reader\Xls - @Erik Tilt [CodePlex #7701](https://phpexcel.codeplex.com/workitem/7701)
- Support for repeating rows and repeating columns (print titles) in \PhpOffice\PhpSpreadsheet\Reader\Xls - @Erik Tilt [CodePlex #7781](https://phpexcel.codeplex.com/workitem/7781)
- Support for print area in \PhpOffice\PhpSpreadsheet\Reader\Xls - @Erik Tilt [CodePlex #7783](https://phpexcel.codeplex.com/workitem/7783)
...
- \PhpOffice\PhpSpreadsheet\Calculation\Functions::DATETIMENOW() and \PhpOffice\PhpSpreadsheet\Calculation\Functions::DATENOW() to force UTC - @MarkBaker [CodePlex #7367](https://phpexcel.codeplex.com/workitem/7367)
- Modified \PhpOffice\PhpSpreadsheet\Shared\Date::formattedPHPToExcel() and \PhpOffice\PhpSpreadsheet\Shared\Date::excelToTimestamp to force datatype for return values - @MarkBaker [CodePlex #7395](https://phpexcel.codeplex.com/workitem/7395)
...
- \PhpOffice\PhpSpreadsheet\Reader\Xlsx setReadDataOnly(true) returns Rich-Text - @MarkBaker [CodePlex #7494](https://phpexcel.codeplex.com/workitem/7494)
- \PhpOffice\PhpSpreadsheet\Reader\Xls setReadDataOnly(true) returns Rich-Text - @Erik Tilt [CodePlex #7496](https://phpexcel.codeplex.com/workitem/7496)
...
- Text rotation and stacked text not working with \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #7531](https://phpexcel.codeplex.com/workitem/7531)
- \PhpOffice\PhpSpreadsheet\Shared\Date::isDateTimeFormatCode erroneously says true - @MarkBaker [CodePlex #7536](https://phpexcel.codeplex.com/workitem/7536)
...
- \PhpOffice\PhpSpreadsheet\Reader\Xls not returning sheet names as UTF-8 using for Excel 95 files - @Erik Tilt [CodePlex #7568](https://phpexcel.codeplex.com/workitem/7568)
- setAutoSize(true) on empty column gives column width of 10 using \PhpOffice\PhpSpreadsheet\Writer\Xlsx - @MarkBaker [CodePlex #7575](https://phpexcel.codeplex.com/workitem/7575)
- setAutoSize(true) on empty column gives column width of 255 using \PhpOffice\PhpSpreadsheet\Writer\Xls - @MB, ET [CodePlex #7573](https://phpexcel.codeplex.com/workitem/7573)
...
- Conditional styles not read properly using \PhpOffice\PhpSpreadsheet\Reader\Xlsx - @MarkBaker [CodePlex #7516](https://phpexcel.codeplex.com/workitem/7516)
...
- Cannot Lock Cells using \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #6940](https://phpexcel.codeplex.com/workitem/6940)
...
- Default row height not working above highest row using \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #7623](https://phpexcel.codeplex.com/workitem/7623)
- Default column width does not get applied when using \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #7637](https://phpexcel.codeplex.com/workitem/7637)
- Broken support for UTF-8 string formula results in \PhpOffice\PhpSpreadsheet\Reader\Xls - @Erik Tilt [CodePlex #7642](https://phpexcel.codeplex.com/workitem/7642)
- UTF-8 sheet names not working with \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #7643](https://phpexcel.codeplex.com/workitem/7643)
...
- Missing BIFF3 functions in \PhpOffice\PhpSpreadsheet\Writer\Xls: USDOLLAR (YEN), FINDB, SEARCHB, REPLACEB, LEFTB, RIGHTB, MIDB, LENB, ASC, DBCS (JIS) - @Erik Tilt [CodePlex #7652](https://phpexcel.codeplex.com/workitem/7652)
...
- Missing BIFF5 functions in \PhpOffice\PhpSpreadsheet\Writer\Xls: ISPMT, DATEDIF, DATESTRING, NUMBERSTRING - @Erik Tilt [CodePlex #7667](https://phpexcel.codeplex.com/workitem/7667)
- Missing BIFF8 functions in \PhpOffice\PhpSpreadsheet\Writer\Xls: GETPIVOTDATA, HYPERLINK, PHONETIC, AVERAGEA, MAXA, MINA, STDEVPA, VARPA, STDEVA, VARA - @Erik Tilt [CodePlex #7668](https://phpexcel.codeplex.com/workitem/7668)
...
- \PhpOffice\PhpSpreadsheet\Reader\Xls not reading explicitly entered error types in cells - @Erik Tilt [CodePlex #7676](https://phpexcel.codeplex.com/workitem/7676)
- Boolean and error data types not preserved for formula results in \PhpOffice\PhpSpreadsheet\Reader\Xls - @Erik Tilt [CodePlex #7678](https://phpexcel.codeplex.com/workitem/7678)
- \PhpOffice\PhpSpreadsheet\Reader\Xlsx ignores cell data type - @MarkBaker [CodePlex #7695](https://phpexcel.codeplex.com/workitem/7695)
- \PhpOffice\PhpSpreadsheet\Reader\Xls ignores cell data type - @Erik Tilt [CodePlex #7712](https://phpexcel.codeplex.com/workitem/7712)
- \PhpOffice\PhpSpreadsheet\Writer\Xls not aware of data type - @Erik Tilt [CodePlex #7587](https://phpexcel.codeplex.com/workitem/7587)
- Long strings sometimes truncated when using \PhpOffice\PhpSpreadsheet\Reader\Xls - @Erik Tilt [CodePlex #7713](https://phpexcel.codeplex.com/workitem/7713)
- Direct entry of boolean or error type in cell not supported by \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #7727](https://phpexcel.codeplex.com/workitem/7727)
- \PhpOffice\PhpSpreadsheet\Reader\Xlsx: Error reading cell with data type string, date number format, and numeric-like cell value - @MarkBaker [CodePlex #7714](https://phpexcel.codeplex.com/workitem/7714)
- Row and column outlines (group indent level) not showing after using \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #7735](https://phpexcel.codeplex.com/workitem/7735)
- Missing UTF-8 support in number format codes for \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #7737](https://phpexcel.codeplex.com/workitem/7737)
- Missing UTF-8 support with \PhpOffice\PhpSpreadsheet\Writer\Xls for explicit string in formula - @Erik Tilt [CodePlex #7750](https://phpexcel.codeplex.com/workitem/7750)
- Problem with class constants in \PhpOffice\PhpSpreadsheet\Style\NumberFormat - @MarkBaker [CodePlex #7726](https://phpexcel.codeplex.com/workitem/7726)
- Sometimes errors with \PhpOffice\PhpSpreadsheet\Reader\Xls reading hyperlinks - @Erik Tilt [CodePlex #7758](https://phpexcel.codeplex.com/workitem/7758)
- Hyperlink in cell always results in string data type when using \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #7759](https://phpexcel.codeplex.com/workitem/7759)
- Excel file with blank sheet seen as broken in MS Office Excel 2007 when created by \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #7771](https://phpexcel.codeplex.com/workitem/7771)
- \PhpOffice\PhpSpreadsheet\Reader\Xls: Incorrect reading of formula with explicit string containing (escaped) double-quote - @Erik Tilt [CodePlex #7785](https://phpexcel.codeplex.com/workitem/7785)
...
- \PhpOffice\PhpSpreadsheet\Reader\Xls: Error reading formulas with sheet reference containing special characters - @Erik Tilt [CodePlex #7802](https://phpexcel.codeplex.com/workitem/7802)
- Off-sheet references sheet!A1 not working with \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #7831](https://phpexcel.codeplex.com/workitem/7831)
- Repeating rows/columns (print titles), print area not working with \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #7834](https://phpexcel.codeplex.com/workitem/7834)
- Formula having datetime number format shows as text when using \PhpOffice\PhpSpreadsheet\Writer\Xls - @Erik Tilt [CodePlex #7849](https://phpexcel.codeplex.com/workitem/7849)
...
- Formula returning error type is lost when read by \PhpOffice\PhpSpreadsheet\Reader\Xlsx - @MarkBaker [CodePlex #7873](https://phpexcel.codeplex.com/workitem/7873)
- \PhpOffice\PhpSpreadsheet\Reader\Xls: Cell style lost for last column in group of blank cells - @Erik Tilt [CodePlex #7883](https://phpexcel.codeplex.com/workitem/7883)
...
- Modified \PhpOffice\PhpSpreadsheet\Shared\Date::PHPToExcel() to force UTC - @MarkBaker [CodePlex #7367](https://phpexcel.codeplex.com/workitem/7367)
...
- Creating a copy of \PhpOffice\PhpSpreadsheet\Spreadsheet object - @MarkBaker [CodePlex #7362](https://phpexcel.codeplex.com/workitem/7362)
...
- \PhpOffice\PhpSpreadsheet\Writer\Xls->setTempDir() not passed to all classes involved in writing to a file - @MarkBaker [CodePlex #7276](https://phpexcel.codeplex.com/workitem/7276)
...
- Set image root of \PhpOffice\PhpSpreadsheet\Writer\Html - @MarkBaker [CodePlex #6249](https://phpexcel.codeplex.com/workitem/6249)
...
- \PhpOffice\PhpSpreadsheet\Spreadsheet handles empty cells other than Excel - @MarkBaker [CodePlex #6347](https://phpexcel.codeplex.com/workitem/6347)
- \PhpOffice\PhpSpreadsheet\Spreadsheet handles 0 and "" as being the same - @MarkBaker [CodePlex #6348](https://phpexcel.codeplex.com/workitem/6348)
...
- Implement \PhpOffice\PhpSpreadsheet\Reader\Xls - @BM [CodePlex #2841](https://phpexcel.codeplex.com/workitem/2841)
...
- Feature request: \PhpOffice\PhpSpreadsheet\Writer\Pdf - @MarkBaker [CodePlex #6039](https://phpexcel.codeplex.com/workitem/6039)
...
- \PhpOffice\PhpSpreadsheet\Reader\Xlsx cannot load \PhpOffice\PhpSpreadsheet\Shared\File - @MarkBaker [CodePlex #5978](https://phpexcel.codeplex.com/workitem/5978)
...
- Use \PhpOffice\PhpSpreadsheet\Spreadsheet datatypes in formula calculation - @MarkBaker [CodePlex #3156](https://phpexcel.codeplex.com/workitem/3156)
...
- Implement more Excel calculation functions - @MarkBaker [CodePlex #2346](https://phpexcel.codeplex.com/workitem/2346)
    ...
    - Reworked excelToTimestamp date method to handle the Excel 1900 leap year
    - Note that this will not correctly return values prior to 13-Dec-1901 20:45:52 as this is the minimum value that PHP date serial values can handle. If you need to work with dates prior to this, then an excelToDateTimeObject method has been added which will work correctly with values between Excel's 1900 calendar base date of 1-Jan-1900, and 13-Dec-1901
    - Addition of excelToDateTimeObject date method to return a PHP DateTime object from an Excel date serial value
...
- Notice: Object of class \PhpOffice\PhpSpreadsheet\RichText\RichText could not be converted to int - @MarkBaker [CodePlex #4125](https://phpexcel.codeplex.com/workitem/4125)
- Excel5Writer: utf8 string not converted to utf16 - @MarkBaker [CodePlex #4126](https://phpexcel.codeplex.com/workitem/4126)
- \PhpOffice\PhpSpreadsheet\RichText\RichText and autosize - @MarkBaker [CodePlex #4180](https://phpexcel.codeplex.com/workitem/4180)
...
- Small bug in \PhpOffice\PhpSpreadsheet\Reader\Xlsx function _readStyle - @MarkBaker [CodePlex #4797](https://phpexcel.codeplex.com/workitem/4797)

## [1.5.0] - 2007-10-23

### Features

- Refactor \PhpOffice\PhpSpreadsheet\Spreadsheet Drawing - @MarkBaker [CodePlex #3265](https://phpexcel.codeplex.com/workitem/3265)
...
- Different improvements in \PhpOffice\PhpSpreadsheet\Reader\Xlsx - @MarkBaker [CodePlex #3082](https://phpexcel.codeplex.com/workitem/3082)

### Features

- Set XML indentation in \PhpOffice\PhpSpreadsheet\Writer\Xlsx - @MarkBaker [CodePlex #3146](https://phpexcel.codeplex.com/workitem/3146)
...
- Printing (\PhpOffice\PhpSpreadsheet\Writer\Xls) - @MarkBaker [CodePlex #3044](https://phpexcel.codeplex.com/workitem/3044)
...
- Memory leak in \PhpOffice\PhpSpreadsheet\Style\Color - @MarkBaker [CodePlex #3077](https://phpexcel.codeplex.com/workitem/3077)
...
- Move \PhpOffice\PhpSpreadsheet\Writer\Xls OLE to \PhpOffice\PhpSpreadsheet\Shared\OLE - @MarkBaker [CodePlex #2812](https://phpexcel.codeplex.com/workitem/2812)
...
- Active sheet index not read/saved - @MarkBaker [CodePlex #2513](https://phpexcel.codeplex.com/workitem/2513)
- Freeze Panes with \PhpOffice\PhpSpreadsheet\Writer\Xls - @MarkBaker [CodePlex #2678](https://phpexcel.codeplex.com/workitem/2678)
...
- \PhpOffice\PhpSpreadsheet\Writer\Xls - @JV
- \PhpOffice\PhpSpreadsheet\Reader\Xlsx: Image shadows - @JV
...
- \PhpOffice\PhpSpreadsheet\Reader\Xlsx: Column auto-size, Protection, Merged cells, Wrap text, Page breaks, Auto filter, Images - @JV
...
- \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::getCell() should not accept absolute coordinates - @MarkBaker [CodePlex #1931](https://phpexcel.codeplex.com/workitem/1931)
...
- \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet->getCellCollection() usort error - @MarkBaker [CodePlex #2290](https://phpexcel.codeplex.com/workitem/2290)
- Bug in \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex - @SS [CodePlex #2353](https://phpexcel.codeplex.com/workitem/2353)
...
- Some refactoring in \PhpOffice\PhpSpreadsheet\Writer\Xlsx\Workbook - @MarkBaker
- New package: PHPExcel_Shared - @MarkBaker
- Password hashing algorithm implemented in \PhpOffice\PhpSpreadsheet\Shared\PasswordHasher - @MarkBaker
- Moved pixel conversion functions to \PhpOffice\PhpSpreadsheet\Shared\Drawing - @MarkBaker
- Switch over to LGPL license - @MarkBaker [CodePlex #244](https://phpexcel.codeplex.com/workitem/244)

### Features

- Include \PhpOffice\PhpSpreadsheet\Spreadsheet version in file headers - @MarkBaker [CodePlex #5](https://phpexcel.codeplex.com/workitem/5)
...
- Syntax error in "Classes/\PhpOffice\PhpSpreadsheet\Spreadsheet/Writer/Excel2007.php" on line 243 - @MarkBaker [CodePlex #1250](https://phpexcel.codeplex.com/workitem/1250)
...
- Number of columns > AZ fails fixed in \PhpOffice\PhpSpreadsheet\Cell\Coordinate::columnIndexFromString - @MarkBaker [CodePlex #913](https://phpexcel.codeplex.com/workitem/913)
...
- \PhpOffice\PhpSpreadsheet\Spreadsheet->removeSheetByIndex now re-orders sheets after deletion, so no array indexes are lost - @JV
- \PhpOffice\PhpSpreadsheet\Writer\Xlsx\Worksheet::_writeCols() used direct assignment to $pSheet->getColumnDimension('A')->Width instead of $pSheet->getColumnDimension('A')->setWidth() - @JV
- DocumentProperties used $this->LastModifiedBy instead of $this->_lastModifiedBy. - @JV

### General

- Only first = should be removed when writing formula in \PhpOffice\PhpSpreadsheet\Writer\Xlsx\Worksheet. - @JV
...
- \PhpOffice\PhpSpreadsheet\Spreadsheet classes (not the Writer classes) can be duplicated, using a duplicate() method. - @MarkBaker
- Cell styles can now be duplicated to a range of cells using \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet->duplicateStyle() - @MarkBaker
- Conditional formatting - @MarkBaker
- Reader for Excel 2007 (not supporting full specification yet!) - @JV

## [1.0.0 RC] - 2007-01-31

- Project name has been changed to \PhpOffice\PhpSpreadsheet\Spreadsheet
- Project homepage is now http://www.codeplex.com/\PhpOffice\PhpSpreadsheet\Spreadsheet
- Started versioning at number: \PhpOffice\PhpSpreadsheet\Spreadsheet 1.0.0 RC
