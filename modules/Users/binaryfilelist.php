...
//$list .= '<tr><td COLSPAN="7" class="blackLine"><IMG SRC="themes/images/blank.gif"></td></tr>';
	...
	while ($row = $adb->fetch_array($result)) {
		...
		$list .= '<tr class="'. $trowclass.'"><td style="padding:0px 3px 0px 3px;" align="center"><a href="index.php?module=Users&action=deletewordtemplate&record=';
		$list .= $row["templateid"].'"> Del </a> </td><td height="21" style="padding:0px 3px 0px 3px;">';
