...
<tr>
	<td class="layerPopupHeading moduleName" align="left">'.$mod_strings["LBL_DELETE_PROFILE"].'</td>
...
<tr>
	...
	<tr>
		<td width="50%" class="dvtCellLabel"><b>'.$mod_strings["LBL_PROFILE_TO_BE_DELETED"].'</b></td>
		<td width="50%" class="dvtCellInfo"><b>'.htmlentities($delete_prof_name,ENT_QUOTES,$default_charset).'</b></td>
	</tr>
	<tr>
		<td align="left" class="dvtCellLabel" nowrap><b>'.$mod_strings["LBL_TRANSFER_ROLES_TO_PROFILE"].'</b></td>
...
<table border=0 cellspacing=0 cellpadding=5 width=100% class="layerPopupTransport">
	<tr>
		<td align=center class="small" style="padding:5px;">
			<input type="submit" name="Delete" value="'.$app_strings["LBL_SAVE_BUTTON_LABEL"].'" class="slds-button slds-button--small slds-button_success">
		</td>
	</tr>
</table>
</form>
