...
<tr>
	<td class="layerPopupHeading moduleName" align="left">' . $mod_strings['LBL_DELETE'] . ' ' . $mod_strings['LBL_USER'] . '</td>
...
<tr>
	...
	<tr>
		...
		<td width="50%" class="dvtCellLabel small"><b>' . $mod_strings['LBL_DELETE_USER'] . '</b></td>
		<td width="50%" class="dvtCellInfo small"><b>' . $delete_user_name . '</b></td>
	</tr>
	<tr>
		<td align="left" class="dvtCellLabel small" nowrap><b>' . $mod_strings['LBL_TRANSFER_USER'] . '</b></td>
		<td align="left" class="dvtCellInfo small">';

$output.='<select class="slds-select" name="transfer_user_id" id="transfer_user_id">';
...
<tr>
	<td align=center class="small" style="padding:5px;"><input type="button" onclick="transferUser(' . $delete_user_id . ')" name="Delete" value="' . $app_strings["LBL_SAVE_BUTTON_LABEL"] . '" class="slds-button slds-button--small slds-button_success">
	</td>
</tr>
</table>
</form></div>';
