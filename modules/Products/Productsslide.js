...
/*
 * array to specify images and optional links. For 4 sided carousel specify at
 * least 2 images For 6 sided carousel specify at least 3 For 8 sided carousel
 * specify at least 4 For 12 sided carousel specify at least 6 If Link is not
 * needed keep it ""
 */
/** *************** DO NOT EDIT BELOW ********************************* */
...
var C_Angle = Car_Direction ? Math.PI/(Car_NoOfSides/2) : 0,
	C_CrImg = Car_NoOfSides,
	C_MaxW,
	C_TotalW,
	C_Stppd = false,
	i,
	C_LeftOffset,
	C_HalfNo = Car_NoOfSides/2;
...
function C_LdLnk() {
	if (this.lnk) window.open(this.lnk,"test","width=600,height=400,resizable=1,scrollbars=1")
}
function C_Stp() {
