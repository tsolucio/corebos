...
if (!is_admin($current_user)) {
	...
	$menu_array['CONFIGURATION']['location'] = 'index.php?module=Settings&action=ProxyServerConfig&parenttab=Settings';
	$menu_array['CONFIGURATION']['image_src']= 'themes/images/proxy.gif';
	$menu_array['CONFIGURATION']['desc'] = getTranslatedString('LBL_PROXY_DESCRIPTION', 'Settings');
	$menu_array['CONFIGURATION']['label']= getTranslatedString('LBL_PROXY_SERVER_CONFIGURATION', 'Settings');
