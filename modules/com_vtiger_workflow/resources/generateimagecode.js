		...
		vtinst.extendSession(handleError(function (result) {
			vtinst.listTypes(handleError(function (accessibleModules) {
				...
				getDescribeObjects(accessibleModules, moduleName, handleError(function (modules) {
					fillSelectBox('save_encoded_value', modules, moduleName, function (e) {
						return e['uitype']=='69m' || e['uitype']=='69';
					});
					$('#save_encoded_value').show();
					fillSelectBox('field_to_encode', modules, moduleName, function (e) {
						return e['uitype']!='69' && e['uitype']!='69m';
					});
					$('#field_to_encode').show();
					$('#encoding_type').show();
				}));
			}));
		}));
