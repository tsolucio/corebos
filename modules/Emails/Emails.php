...
class Emails extends CRMEntity {
	...
	public static function emailServerCheck() {
		...
		$user_og_server_config = $adb->pquery('select *from vtiger_mail_accounts where user_id = ? AND og_server_validation_status=0 AND og_server_status=1', array($current_user->id));
