...
function customFieldMappings() {
	...
	$convert_sql = "SELECT vtiger_convertleadmapping.*,uitype,fieldlabel,typeofdata,fieldid
		FROM vtiger_field
		LEFT JOIN vtiger_convertleadmapping ON vtiger_field.fieldid = vtiger_convertleadmapping.leadfid
		WHERE tabid=? AND vtiger_field.presence IN (0,2)
