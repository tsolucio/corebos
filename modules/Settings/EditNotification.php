...
//Added to show the previous selected value when editing
	...
	$query='select vtiger_emailtemplates.templateid,vtiger_emailtemplates.templatename
	...
	$result = $adb->pquery('select * from vtiger_notificationscheduler where schedulednotificationid = ?', array($id));
