...
$output .= '<td class="layerPopupHeading cblds-p--medium" align="left">'.$display_module.' - ';
if ($mode == 'edit') {
	$output .= $mod_strings['LBL_EDIT_CUSTOM_RULE'].'</td>';
} else {
	$output .= $mod_strings['LBL_ADD_CUSTOM_RULE'].'</td>';
}
$output .= '<td align="right" class="small"><img src="'. vtiger_imageurl('close.gif', $theme).'" border=0 alt="'.$app_strings['LBL_CLOSE']
	.'" title="'.$app_strings['LBL_CLOSE'].'" style="cursor:pointer" onClick="hide(\'sharingRule\')";></td>
...
<tr>
	...
	<tr>
		<td class="cblds-p--medium"><b>'.$mod_strings['LBL_STEP'].' 1 : '.$display_module.' '.$app_strings['LBL_LIST_OF'].' </b>('.$mod_strings['LBL_SELECT_ENTITY'].')</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
...
//combovalues
	...
	<tr>
		<td class="cblds-p--medium" style="text-align:left;"><b>'.$mod_strings['LBL_STEP'].' 2 : '.$mod_strings['LBL_CAN_BE_ACCESSED_BY'].' </b>('.$mod_strings['LBL_SELECT_ENTITY'].')</td>
	...
	<tr>
		<td style="white-space:normal;" class="cblds-p--medium" colspan="2" id="rules">&nbsp;
	</td>
	</tr>
	<tr>
...
<table border=0 cellspacing=0 cellpadding=5 width=100% class="layerPopupTransport">
	<tr>
		<td colspan="2" align="center" class="cblds-p--medium cblds-t-align--center">
