...
$qry = 'select * from vtiger_'.$tableName
	." inner join vtiger_role2picklist on vtiger_role2picklist.picklistvalueid=vtiger_$tableName.picklist_valueid where roleid=? and presence=0 order by sortid";
...
$query = 'select fieldlabel
	...
	where vtiger_tab.name=? and fieldname=? and vtiger_field.presence in (0,2)';
