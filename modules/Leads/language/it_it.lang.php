...
if (isset($_COOKIE['LeadConv']) && $_COOKIE['LeadConv'] == 'true') {
	$toggle_historicos = 'Vedere Lead non Convertiti';
	$toggle_name = 'Lead convertiti';
} else {
	$toggle_historicos = 'Vedere Lead Convertiti';
	$toggle_name = 'Leads';
}
...
$mod_strings = array(
	...
	'LBL_POTENTIAL_CLOSE_DATE' => 'Data di chiusura opportunità',
	'LBL_POTENTIAL_AMOUNT' => 'Ammontare opportunità',
	'LBL_POTENTIAL_SALES_STAGE' => 'Stadio di vendita opportunità',
	...
	'LBL_DO_NOT_CREATE_NEW_POTENTIAL' => 'Non creare una nuova opportunità  fino alla conversione',
	...
	'Lead No' => 'Nr. Lead',
	'LBL_TRANSFER_RELATED_RECORDS_TO' => 'Trasferisci entità collegate a',
	...
	'LBL_LEADS_FIELD_MAPPING' => 'Mappatura Campi Personalizzata Leads',
	'LBL_FIELD_SETTINGS' => 'Impostazioni Campo',
	'Leads ID' => 'Leads ID',
	'LeadAlreadyConverted' => 'Lead non può essere convertito. O è già stato convertito o non si dispone dell&apos;autorizzazione per uno o più moduli di destinazione.',
);
?>
