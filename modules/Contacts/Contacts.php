	...
	*/
	...
	function transferRelatedRecords($module, $transferEntityIds, $entityId) {
		...
		$rel_table_arr = Array("Potentials"=>"vtiger_contpotentialrel","Activities"=>"vtiger_cntactivityrel","Emails"=>"vtiger_seactivityrel",
				...
				"Attachments"=>"vtiger_seattachmentsrel","Campaigns"=>"vtiger_campaigncontrel","ModComments"=>"vtiger_modcomments","cbCalendar"=>"vtiger_activity");
		...
		$tbl_field_arr = Array("vtiger_contpotentialrel"=>"potentialid","vtiger_cntactivityrel"=>"activityid","vtiger_seactivityrel"=>"activityid",
				...
				"vtiger_seattachmentsrel"=>"attachmentsid","vtiger_campaigncontrel"=>"campaignid","vtiger_modcomments"=>"modcommentsid","vtiger_activity"=>"activityid");
		...
		$entity_tbl_field_arr = Array("vtiger_contpotentialrel"=>"contactid","vtiger_cntactivityrel"=>"contactid","vtiger_seactivityrel"=>"crmid",
				...
				"vtiger_seattachmentsrel"=>"crmid","vtiger_campaigncontrel"=>"contactid","vtiger_modcomments"=>"related_to","vtiger_activity"=>"cto_id");
