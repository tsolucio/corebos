...
class crmtogo_UI_GetScrollRecords extends crmtogo_WS_getScrollContent {
	...
	public function process(crmtogo_API_Request $request) {
		...
		for ($i=0; $i<$noofrows; $i++) {
			...
			$fetchRecordUrl = 'http://localhost/corebos/modules/Mobile/index.php?_operation=fetchRecord&record=' . $id;
			$editUrl = 'http://localhost/corebos/modules/Mobile/index.php?_operation=edit&record=' . $id;
			$output .= '<li style="display: flex;">
				<a class="ui-btn ui-icon-carat-r" style="flex: 1;" target="_self" href="'. $fetchRecordUrl .'" target="_self">
					...
					<a class="ui-btn ui-icon-carat-r" style="padding: 7.5px;" target="_self" href="'. $editUrl .'" target="_self">
						<img src="/corebos/modules/Mobile/resources/css/images/edit_Icon.png" alt="edit" style="height: 25px;">
					</a>
				</a>
			</li>';
		}
