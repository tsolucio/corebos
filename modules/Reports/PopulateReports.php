...
$reports = array(
	array('reportname'=>'Contacts by Accounts',
...
$sortorder = array(
	array(
		array('columnname'=>'vtiger_leaddetails:leadsource:Leads_Lead_Source:leadsource:V', 'sortorder'=>'Ascending')
	),
	array(
		array('columnname'=>'vtiger_leaddetails:leadstatus:Leads_Lead_Status:leadstatus:V', 'sortorder'=>'Ascending')
	),
	array(
		array('columnname'=>'vtiger_potential:sales_stage:Potentials_Sales_Stage:sales_stage:V', 'sortorder'=>'Ascending')
	),
	array(
		array('columnname'=>'vtiger_troubletickets:priority:HelpDesk_Priority:ticketpriorities:V', 'sortorder'=>'Ascending')
	)
);
