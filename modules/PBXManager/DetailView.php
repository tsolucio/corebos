...
$blocks[$idx['block_label']]['__fields'][$idx['field_key']][$flabel]['value'] = $value;
$flabel = getTranslatedString('Call To', 'PBXManager');
$idx = getFieldFromDetailViewBlockArray($blocks, $flabel);
$value = html_entity_decode($blocks[$idx['block_label']]['__fields'][$idx['field_key']][$flabel]['value'], ENT_QUOTES, $default_charset);
$blocks[$idx['block_label']]['__fields'][$idx['field_key']][$flabel]['value'] = $value;
