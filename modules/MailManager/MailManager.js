...
//                    jQuery('#mm_selected_folder').val(currentSelectedFolder);
        ...
        toggleSelect : function(state, relCheckName) {
            ...
            for(i=0; i<elements.length; i++) {
                ...
                if(state) {
                    element.prop('checked',state).parent().parent().parent().addClass('mm_lvtColDataHover').removeClass('mm_lvtColData');
                } else {
                    element.prop('checked',state).parent().parent().parent().removeClass('mm_lvtColDataHover').addClass('mm_lvtColData');
                }
            }
        },
        ...
        toggleSelectMail : function(state, element) {
            if(state) {
                jQuery(element).parent().parent().parent().addClass('mm_lvtColDataHover').removeClass('mm_lvtColData');
            } else {
                jQuery(element).parent().parent().parent().addClass('mm_lvtColData').removeClass('mm_lvtColDataHover');
            }
