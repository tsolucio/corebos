<?php
/**
* OpenDocument_DrawEquation class
*
...
/**
* OpenDocument_DrawEquation element
*
* @category   File Formats
* @package    OpenDocument
...
*/
class OpenDocument_DrawEquation extends OpenDocument_StyledElement {
	/**
	 * Node namespace
	 */
	 ...
	 *
	 * @param mixed $object
	 * @return OpenDocument_DrawEquation
	...
	public static function instance($object) {
		...
		$element = new OpenDocument_DrawEquation($node->ownerDocument->createElementNS(self::nodeNS, self::nodeName), $document);
