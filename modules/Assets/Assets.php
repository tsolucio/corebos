...
class Assets extends CRMEntity {
	...
	public $moduleIcon = array('library' => 'standard', 'containerClass' => 'slds-icon_container slds-icon-standard-asset-relationship', 'class' => 'slds-icon', 'icon'=>'asset_relationship');
