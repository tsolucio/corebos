...
$log->debug("Update ListPrice in (modules/Services/UpdateListPrice.php): $pricebook_id $product_id $listprice");
...
header("Location: index.php?module=$return_module&action=".$return_module."Ajax&file=$return_action&ajax=updatelistprice&record=".urlencode($record));
?>
