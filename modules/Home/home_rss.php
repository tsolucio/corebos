...
$query = 'select vtiger_crmentity.setype,vtiger_crmentity.crmid,vtiger_crmentity.smcreatorid,vtiger_crmentity.modifiedtime
	from vtiger_crmentity inner join vtiger_ownernotify on vtiger_crmentity.crmid=vtiger_ownernotify.crmid';
...
for ($i=0; $i<$adb->num_rows($result); $i++) {
	...
	} elseif ($mod_notify[$i]['setype']=='Potentials') {
	...
	} elseif ($mod_notify[$i]['setype']=='Contacts') {
	...
	} elseif ($mod_notify[$i]['setype']=='Leads') {
	...
	} elseif ($mod_notify[$i]['setype']=='SalesOrder') {
	...
	} elseif ($mod_notify[$i]['setype']=='Orders') {
	...
	} elseif ($mod_notify[$i]['setype']=='Products') {
	...
	} elseif ($mod_notify[$i]['setype']=='Emails') {
	...
	} elseif ($mod_notify[$i]['setype']=='HelpDesk') {
	...
	} elseif ($mod_notify[$i]['setype']=='Quotes') {
	...
	} elseif ($mod_notify[$i]['setype']=='Invoice') {
