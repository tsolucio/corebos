...
if (!is_admin($current_user)) {
	...
	$menu_array['STORAGESIZE_CONFIGURATION']['location'] = 'index.php?module=Documents&action=StorageConfig&parenttab=Settings&formodule=Documents';
	$menu_array['STORAGESIZE_CONFIGURATION']['image_src']= 'modules/Documents/images/HardDrive4848.png';
	$menu_array['STORAGESIZE_CONFIGURATION']['desc'] = getTranslatedString('STORAGESIZE_CONFIGURATION_DESCRIPTION', $module);
	$menu_array['STORAGESIZE_CONFIGURATION']['label'] = getTranslatedString('STORAGESIZE_CONFIGURATION', $module);
