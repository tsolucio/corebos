...
require_once 'gcal/src/Google/Auth/AssertionCredentials.php';
require_once 'gcal/src/Google/Cache/File.php';
require_once 'gcal/src/Google/Cache/Memcache.php';
require_once 'gcal/src/Google/Config.php';
require_once 'gcal/src/Google/Collection.php';
require_once 'gcal/src/Google/Exception.php';
require_once 'gcal/src/Google/IO/Curl.php';
require_once 'gcal/src/Google/IO/Stream.php';
require_once 'gcal/src/Google/Model.php';
require_once 'gcal/src/Google/Service.php';
require_once 'gcal/src/Google/Service/Resource.php';
