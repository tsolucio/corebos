...
if ($GoogleSync4You->isLogged()) {
    ...
    if (!$is_full_day_event) echo " ".$time_arr['starthour'].":".$time_arr['startmin'].$time_arr['startfmt'];
    echo "<br />"; 
    
    echo $app_strings[($is_full_day_event?"LBL_END_DATE":"LBL_END_DATE_TIME")].": " . $user_date_end;
    if (!$is_full_day_event) echo " ".$time_arr['endhour'].":".$time_arr['endmin'].$time_arr['endfmt'];
    echo "<br />"; 
