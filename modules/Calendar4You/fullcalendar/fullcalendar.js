...
//ITS4You VlME Start
function getSkinCss2(event, opt) {
	var source = event.source || {};
	var eventColor = event.title_color;
	var sourceColor = source.title_color;
	var optionColor = opt('title_eventColor');
	var backgroundColor =
		event.backgroundColor ||
		eventColor ||
		source.backgroundColor ||
	...
	var borderColor =
		...
		optionColor;
	var textColor =
		event.title_textColor ||
		source.title_textColor ||
		opt('eventTextColor');
	var statements = [];
	if (backgroundColor) {
		statements.push('background-color:' + backgroundColor);
...
function ListView(element, calendar) {
    ...
    window.location.href = "index.php?action=ListView&module=Calendar4You&parenttab=Tools";
    
    t.render = "aaaaaaaaaaaaa";
}
...
function AgendaEventRenderer() {
	...
	function slotSegHtml(event, seg) {
        ...
        var skinCss2 = getSkinCss2(event, opt);
		...
		html +=
			...
			"<div class='fc-event-time' style='" + skinCss2 + "margin-bottom:2px'>" +  //ITS4You VlMe
