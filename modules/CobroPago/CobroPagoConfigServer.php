	...
	<!-- 
	  ...
	  <tr>
	    ...
	    <td>
	      ...
	      <option value='LIVE'<?php if ($ts_bmode=='LIVE') echo ' selected="selected"';?>>LIVE</option>
	      <option value='TEST'<?php if ($ts_bmode=='TEST') echo ' selected="selected"';?>>TEST</option>
	      </select>
	    </td>
	  </tr>
	   -->
	  <tr>
	    ...
	    <td>
	      <input type="checkbox" name="block_paid" <?php if ($ts_bpaid=='on') echo 'checked';?>>
	    </td>
	  </tr>
	  <tr>
		<td>
