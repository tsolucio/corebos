...
require 'modules/Dashboard/graphdefinitions.php';
	...
	if(isset($_REQUEST['from_page']) && $_REQUEST['from_page'] == 'HomePage')
	{
		...
		elseif ($userprivs->hasModuleAccess(getTabid('Products')) && ($type == "productbypo") && $userprivs->hasModuleAccess(getTabid("PurchaseOrder")) == 0)
		{
		...
		elseif ($userprivs->hasModuleAccess(getTabid('Products')) && ($type == "productbyquotes") && $userprivs->hasModuleAccess(getTabid("Quotes")) == 0)
		{
			$graph_by="quoteid";
		...
		elseif ($userprivs->hasModuleAccess(getTabid('Products')) && ($type == "productbyinvoice") && $userprivs->hasModuleAccess(getTabid("Invoice")) == 0)
		{
			$graph_by="invoiceid";
		...
		elseif ($userprivs->hasModuleAccess(getTabid('Contacts')) && ($type == "contactbycampaign") && $userprivs->hasModuleAccess(getTabid("Campaigns")) == 0)
		{
			$graph_by="campaignid";
