						...
						<form method="post" id="login_form" action="index.php" target="_top" autocomplete="off" novalidate="novalidate">
							...
							<div id="usernamegroup" class="inputgroup">
								<div id="username_container">
									<input class="input r4 wide mb16 mt8 username" type="email" value="{$uname}" name="user_name" id="username" style="display: block;" placeholder="{'LBL_USER_NAME'|getTranslatedString:'Users'}" readonly>
								</div>
							</div>
							<input class="input r4 wide mb16 mt8 password" type="text" id="user_2facode" name="user_2facode"
								onkeypress="checkCaps(event)" autocomplete="off" placeholder="{'LBL_2FACODE'|getTranslatedString:'Users'}">
