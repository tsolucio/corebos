		...
		<div class="loginForm">
			<form action="index.php" method="post" id="form">
				...
				<div class="inputs">
					...
					<div class="input">
						<input type="text" name="user_name" value="{$uname}" readonly />
					</div>
					<br />
					<div class="label">{'LBL_2FACODE'|getTranslatedString:'Users'}</div>
					<div class="input">
						<input type="text" name="user_2facode" value="" />
					</div>
					<div class="input">
						<br><a href="javascript:sendnew2facode({$authuserid});">{'LBL_2FAGETCODE'|getTranslatedString:'Users'}</a><br>
					</div>
					{if $LOGIN_ERROR neq ''}
