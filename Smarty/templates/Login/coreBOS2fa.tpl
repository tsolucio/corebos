					...
					<form action="index.php" method="post" id="form">
						...
						<table border="0">
							<tr>
								...
								<td valign="middle"><input type="text" name="user_name" tabindex="1" value="{$uname}" readonly></td>
							...
							<tr>
								...
								<td valign="middle"><input type="password" name="user_password" tabindex="2" value="****" readonly></td>
							</tr>
							<tr>
								<td valign="middle">{'LBL_2FACODE'|getTranslatedString:'Users'}</td>
								<td valign="middle"><input type="text" name="user_2facode" tabindex="3" value=""></td>
							</tr>
							<tr>
								<td valign="middle"></td>
								<td valign="middle"><a href="javascript:sendnew2facode({$authuserid});">{'LBL_2FAGETCODE'|getTranslatedString:'Users'}</a></td>
							</tr>
						</table>
						{if $LOGIN_ERROR neq ''}
