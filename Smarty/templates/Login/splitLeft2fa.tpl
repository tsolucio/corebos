					...
					<div class="form-group row i-required">
						...
						<div class="col-8">
							<input class="form-control"
								id="input_a52510ad-f89c-43de-a600-5c527e644782" name="user_name" value="{$uname}" readonly
								type="text" required="">
						</div>
					</div>
					<div class="form-group row i-required">
						<label class="form-control-label col-form-label col-4 text-right"
							for="input_8ba9a4bb-9a53-4f25-87c4-23e961bfcf2a">{'LBL_2FACODE'|getTranslatedString:'Users'}</label>
						<div class="col-8">
							<input class="form-control"
								id="input_8ba9a4bb-9a53-4f25-87c4-23e961bfcf2a" name="user_2facode"
								type="text" required="">
							<div><br><a href="javascript:sendnew2facode({$authuserid});">{'LBL_2FAGETCODE'|getTranslatedString:'Users'}</a></div>
						</div>
					</div>
					{if $LOGIN_ERROR neq ''}
