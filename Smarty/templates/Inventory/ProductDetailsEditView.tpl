   ...
   <tr id="row{$row_no}" valign="top">
	...
	<td class="crmTableRow small lineOnTop inv-editview__namecol">
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="1">
			<tr>
				<td class="small cblds-p--none" valign="top">
			...
			<tr>
				<td class="small cblds-p--xx-small">
			...
			<tr>
				<td class="small cblds-p--none" id="setComment">
	...
	<td class="crmTableRow small lineOnTop inv-editview__pricecol" align="right" valign="top">
		<table width="100%" cellpadding="0" cellspacing="0">
		   ...
		   <tr id="individual_tax_row{$row_no}" class="TaxShow">
			<td align="right" class="cblds-t-align--right" style="padding:5px;" nowrap>
				...
				<div class="discountUI" id="tax_div{$row_no}">
					...
					{foreach key=tax_row_no item=tax_data from=$data.taxes}
					   ...
					   <tr>
						...
						<td align="center" class="cblds-t-align--center" class="lineOnTop">{$tax_data.taxlabel}</td>
						<td align="right" class="lineOnTop cblds-t-align--right">
...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="0" class="crmTable">
   <!-- Add Product Button -->
   <tr>
	<td colspan="3" class="cblds-p--medium">
...
{assign var="FINAL" value=$ASSOCIATEDPRODUCTS.1.final_details}
   ...
   <tr valign="top">
	<td width="88%" colspan="2" class="crmTableRow small lineOnTop cblds-t-align--right" align="right"><b>{$APP.LBL_NET_TOTAL}</b></td>
	<td width="12%" id="netTotal" class="crmTableRow small lineOnTop cblds-t-align--right" align="right">0.00</td>
   </tr>

   <tr valign="top">
	<td class="crmTableRow small lineOnTop" width="60%" style="border-right:1px #dadada;">&nbsp;</td>
	<td class="crmTableRow small lineOnTop cblds-t-align--right" align="right">
		...
		<div class="discountUI" id="discount_div_final">
			...
			<table width="100%" border="0" cellpadding="5" cellspacing="0" class="small">
			   <tr>
				...
				<td align="right" class="cblds-t-align--right"><img src="{'close.gif'|@vtiger_imageurl:$THEME}" border="0" onClick="fnhide('discount_div_final')" style="cursor:pointer;"></td>
			   </tr>
			   <tr>
			   ...
			   <tr>
				...
				<td align="right" class="cblds-t-align--right"><input type="text" class="small" size="5" id="discount_percentage_final" name="discount_percentage_final" value="{$FINAL.discount_percentage_final}" {if isset($FINAL.style_discount_percentage_final)}{$FINAL.style_discount_percentage_final}{/if} onBlur="setDiscount(this,'_final'); calcGroupTax(); calcTotal();">&nbsp;%</td>
			   </tr>
			   <tr>
				...
				<td align="right" class="cblds-t-align--right"><input type="text" id="discount_amount_final" name="discount_amount_final" size="5" value="{$FINAL.discount_amount_final}" {if isset($FINAL.style_discount_amount_final)}{$FINAL.style_discount_amount_final}{/if} onBlur="setDiscount(this,'_final');  calcGroupTax(); calcTotal();"></td>
			   </tr>
			</table>
		</div>
		<!-- End Div -->
	...
	<td id="discountTotal_final" class="crmTableRow small lineOnTop cblds-t-align--right" align="right">{$FINAL.discountTotal_final}</td>
   </tr>
   ...
   <tr id="group_tax_row" valign="top" class="TaxHide">
	...
	<td id="tax_final" class="crmTableRow small lineOnTop cblds-t-align--right" align="right">{$FINAL.tax_totalamount}</td>
   </tr>
   <!-- Group Tax - ends -->
...
{if $SHOW_SHIPHAND_CHARGES}
   <tr valign="top">
	...
	<td class="crmTableRow small cblds-t-align--right" align="right">
...
{if !empty($FINAL.sh_taxes)}
   <tr valign="top">
				...
				<div class="discountUI" id="shipping_handling_div">
					<table width="100%" border="0" cellpadding="5" cellspacing="0" class="small">
					   <tr>
						...
						<td align="right" class="cblds-t-align--right"><img src="{'close.gif'|@vtiger_imageurl:$THEME}" border="0" onClick="fnhide('shipping_handling_div')" style="cursor:pointer;"></td>
					   </tr>
					...
					{foreach item=tax_detail name=sh_loop key=loop_count from=$FINAL.sh_taxes}
					   ...
					   <tr>
						...
						<td align="center" class="lineOnTop cblds-t-align--center">{$tax_detail.taxlabel}</td>
						<td align="right" class="lineOnTop cblds-t-align--right">
	...
	<td id="shipping_handling_tax" class="crmTableRow small cblds-t-align--right" align="right">{$FINAL.shtax_totalamount}</td>
   </tr>
{/if}
   <tr valign="top">
	<td class="crmTableRow small" style="border-right:1px #dadada;">&nbsp;</td>
   ...
   <tr valign="top">
	...
	<td class="crmTableRow big lineOnTop cblds-t-align--right" align="right"><b>{$APP.LBL_GRAND_TOTAL}</b></td>
	<td id="grandTotal" name="grandTotal" class="crmTableRow big lineOnTop cblds-t-align--right" align="right">{$FINAL.grandTotal}</td>
   </tr>
</table>
