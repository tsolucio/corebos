...
<form enctype="multipart/form-data" name="mergeDuplicates" method="post" action="index.php?module={$MODULE}&action=FindDuplicateRecords" onsubmit="VtigerJS_DialogBox.block();">
	...
	<table class="searchUIBasic small" border="0" cellpadding="5" cellspacing="0" width="80%" height="10" align="center">
		<tbody><tr class="lvtCol" style="Font-Weight: normal"><br>
					<td colspan="2" class="cblds-p--medium">
					...
					<td valign="top" align="right" class="small cblds-t-align--right">
						<span>&nbsp;</span>
				...
				<tr>
					<td class="cblds-p--medium"><b>{$APP.LBL_AVAILABLE_FIELDS}</b></td>
					<td></td>
					<td class="cblds-p--medium"><b>{$APP.LBL_SELECTED_FIELDS}</b></td>
				</tr>
				<tr>
					<td width=47% class="cblds-p--medium">
				...
				<tr>
					<td colspan="3" align="center" class="cblds-t-align--center cblds-p--medium">
