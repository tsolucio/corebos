...
<tbody><tr>
	...
	<div align=center>
			{include file='SetMenu.tpl'}
				...
				<tbody><tr>
					<td rowspan="2" valign="top" width="50" class="cblds-p--none"><img src="{'ico-profile.gif'|@vtiger_imageurl:$THEME}" alt="{$MOD.LBL_PROFILES}" title="{$MOD.LBL_PROFILES}" border="0" height="48" width="48"></td>
				...
				<tr>
					<td class="small cblds-p-v--none" valign="top">{$CMOD.LBL_PROFILE_MESG} &quot;{$PROFILE_NAME}&quot; </td>
				</tr>
				</tbody></table>
				...
				<td valign="top">
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tbody><tr>
                        <td class="cblds-p--none"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody><tr class="small">
                              <td class="cblds-p--none cblds-p-v--medium"><img src="{'prvPrfTopLeft.gif'|@vtiger_imageurl:$THEME}"></td>
                              <td class="prvPrfTopBg cblds-p--none" width="100%"></td>
                              <td class="cblds-p--none"><img src="{'prvPrfTopRight.gif'|@vtiger_imageurl:$THEME}"></td>
                            </tr>
                          </tbody></table>
                            <table class="prvPrfOutline" border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tbody><tr>
                                <td class="cblds-p--none"><!-- tabs -->
                                    <!-- Headers -->
						...
						<td align="right" width="40%" class="cblds-t-align--right"><a href="javascript:fnhide('renameProfile');"><img src="{'close.gif'|@vtiger_imageurl:$THEME}" align="middle" border="0"></a></td>
						</tr>
						</table>
						...
						<td class="small">
							<table cellspacing="0" align="center" bgcolor="white" border="0" cellpadding="5" width="100%">
								<tr>
								<td align="right" class="cblds-t-align--right" width="25%" style="padding-right:10px;" nowrap><b>{$APP.LBL_PROFILE_NAME} :</b></td>
								...
								<tr>
								<td align="right" class="cblds-t-align--right" width="25%" style="padding-right:10px;" nowrap><b>{$APP.LBL_DESCRIPTION} :</b></td>
					    ...
					    <tr>
						<td align = "center" class="cblds-t-align--center">
						...
						<table class="small" align="center" border="0" cellpadding="5" cellspacing="0" width="90%">
                                                <tbody><tr>
                                                    ...
                                                    <td valign="top" width="97%"><table class="small" border="0" cellpadding="2" cellspacing="0" width="100%">
                                                      <tbody>
				                         <tr id="gva">
                                                          <td valign="top" class="cblds-p--none">{$GLOBAL_PRIV.0}</td>
                                                          <td class="cblds-p--none"><b>{$CMOD.LBL_VIEW_ALL}</b> </td>
                                                        </tr>
                                                        <tr >
                                                          <td valign="top" class="cblds-p--none"></td>
                                                          <td width="100%" class="cblds-p--none">{$CMOD.LBL_ALLOW} "{$PROFILE_NAME}" {$CMOD.LBL_MESG_VIEW}</td>
                                                        </tr>
                                                        <tr>
                                                          <td>&nbsp;</td>
                                                        </tr>
							<tr>
							<td valign="top" class="cblds-p--none">{$GLOBAL_PRIV.1}</td>
							<td class="cblds-p--none"><b>{$CMOD.LBL_EDIT_ALL}</b> </td>
							</tr>
                                                        <tr>
                                                          <td valign="top"></td>
...
<br>
			...
			<table class="small" align="center" border="0" cellpadding="5" cellspacing="0" width="90%">
			  <tbody><tr>
				...
				<table class="small listTable" border="0" cellpadding="5" cellspacing="0" width="100%">
			        <tbody>
				<tr id="gva">
			          <td colspan="7" class="small colHeader cblds-p-v--medium"><div align="center"><strong> {$CMOD.LBL_EDIT_PERMISSIONS} </strong></div></td>
			        </tr>
			        <tr id="gva">
			          <td colspan="2" class="small colHeader cblds-p-v--medium"><strong> {$CMOD.LBL_TAB_MESG_OPTION} </strong><strong></strong></td>
			          <td class="small colHeader cblds-p-v--medium"><div align="center"><strong>{$CMOD.LBL_CREATE}</strong></div></td>
			          <td class="small colHeader cblds-p-v--medium"><div align="center"><strong>{$CMOD.Edit}</strong></div></td>
			          <td class="small colHeader cblds-p-v--medium"> <div align="center"><strong>{$CMOD.LBL_VIEW} </strong></div></td>
			          <td class="small colHeader cblds-p-v--medium"> <div align="center"><strong>{$CMOD.LBL_DELETE}</strong></div></td>
			          <td class="small colHeader cblds-p-v--medium" nowrap="nowrap"> {$CMOD.LBL_FIELDS_AND_TOOLS_SETTINGS} </td>
			        </tr>
				...
				{/if}
						...
						<table class="small cblds-p--large" border="0" cellpadding="2" cellspacing="0" width="100%" style="border-collapse: separate;">
			        	    	<tbody>
						{if !empty($FIELD_PRIVILEGES[$tabid])}
						<tr>
							{if $modulename eq 'Calendar'}
								<td class="small colHeader cblds-p-v--medium" colspan="7" valign="top">{$CMOD.LBL_FIELDS_TO_BE_SHOWN} ({$APP.Tasks})</td>
							{else}
								<td class="small colHeader cblds-p-v--medium" colspan="7" valign="top">{$CMOD.LBL_FIELDS_TO_BE_SHOWN}</td>
							{/if}
						</tr>
						{foreach item=row_values from=$FIELD_PRIVILEGES[$tabid]}
				            	<tr>
						      {foreach item=element from=$row_values}
					              <td valign="top" class="cblds-p--none cblds-p-v--mediumsmall">
									  <span>{$element.1}</span>
									  <span>{$element.2}</span>
								  </td>
					              <td class="cblds-p--none cblds-p-v--mediumsmall">{$element.0}</td>
						      {/foreach}
				                </tr>
						{/foreach}
						{/if}
						{if $modulename eq 'Calendar'}
						<tr>
							<td class="small colHeader cblds-p-v--medium" colspan="7" valign="top">{$CMOD.LBL_FIELDS_TO_BE_SHOWN}  ({$APP.Events})</td>
						</tr>
						...
						<tr>
							<td colspan="7" class="small colHeader cblds-p-v--medium" valign="top">{$CMOD.LBL_TOOLS_TO_BE_SHOWN} </td>
						</tr>
						{foreach item=util_value from=$UTILITIES_PRIV[$tabid]}
						<tr>
							{foreach item=util_elements from=$util_value}
					              		<td valign="top" class="cblds-p--none cblds-p-v--mediumsmall">{$util_elements.1}</td>
						                <td class="cblds-p--none cblds-p-v--mediumsmall">{$APP[$util_elements.0]}</td>
							{/foreach}
				               	</tr>
						{/foreach}
						{/if}
		...
		<table border="0" cellpadding="2" cellspacing="0">
			<tr>
				<td align="left" class="cblds-p-v--none"><font color="red" size=5>*</font>&nbsp;{$CMOD.LBL_MANDATORY_MSG}</td>
			</tr>
			<tr>
				<td align="left" class="cblds-p-v--none"><font color="blue" size=5>*</font>&nbsp;{$CMOD.LBL_DISABLE_FIELD_MSG}</td>
			</tr>
			<tr>
		...
		<tr>
		<td style="border-top: 2px dotted rgb(204, 204, 204);" align="right" class="cblds-t-align--right">
		<!-- wizard buttons -->
	...
	<p>&nbsp;</p>
	<table border="0" cellpadding="5" cellspacing="0" width="100%">
	<tbody><tr><td class="small cblds-t-align--right" align="right" nowrap="nowrap"><a href="#top">{$MOD.LBL_SCROLL}</a></td></tr>
	</tbody></table>
	</td>
	</tr>
	</tbody></table>
