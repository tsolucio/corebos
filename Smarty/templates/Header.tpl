...
<TABLE border=0 cellspacing=0 cellpadding=0 width=100% class="hdrTabBg">
	<tr>
		...
		<td class=small nowrap>
			<table border=0 cellspacing=0 cellpadding=0>
				<tr>
					<td><div id="evvtmenudiv" style="display:none;"><ul id="menutree"></ul></div></td>
...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		kendo.culture('{/literal}{$KUILANG}{literal}');
		var evvtmenu={/literal}{$MENU}{literal};
		var menu = jQuery("#menutree").kendoMenu({dataSource:evvtmenu });
		jQuery('#evvtmenudiv').show();
	});
	{/literal}
</script>
<link href="include/kendoui/styles/kendo.common.min.css" rel="stylesheet" type="text/css"/>
{if $THEME eq 'vtmkt'}
	<link href="themes/vtmkt/vtmkt.css" rel="stylesheet" type="text/css"/>
{else}
	<link href="include/kendoui/styles/kendo.bootstrap.min.css" rel="stylesheet" type="text/css"/>
{/if}
<script type="text/javascript" src="include/kendoui/js/kendo.web.min.js"></script>
<script type="text/javascript" src="include/kendoui/lang/kendo.{$KUILANG}.js"></script>
<script type="text/javascript" src="include/kendoui/js/cultures/kendo.culture.{$KUILANG}.min.js"></script>
<script type="text/javascript" src="include/kendoui/kendo.popup.min.js"></script>
