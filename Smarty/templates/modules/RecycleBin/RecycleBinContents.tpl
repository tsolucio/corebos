		...
		<td style="background-color:#efefef;height:340px" align="center" colspan="{$smarty.foreach.listviewforeach.iteration+2}">
			...
			<tr>
				<td align="center">
					...
					<table cellspacing=0 cellpadding=5 width=98% border=0 align=center class="cblds-t-align--center">
						<tr>
							<td rowspan="2" width="30%" align='right' class="cblds-t-align--right"><img src="{'empty.jpg'|@vtiger_imageurl:$THEME}" height="60"></td>
