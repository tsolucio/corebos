			...
			<div class="slds-card__header slds-grid">
				<header class="slds-media slds-media--center slds-has-flexi-truncate">
					<div class="slds-media__figure">
						<div class="extraSmall forceEntityIcon" style="height: 1rem;" data-aura-rendered-by="3:1782;a" data-aura-class="forceEntityIcon">
								...
								<a href="javascript:showHideStatus('tbl{$UIKEY}','aid{$UIKEY}','{$IMAGE_PATH}');">
									{if $BLOCKOPEN}
										<span class="exp_coll_block inactivate">
											<img id="aid{$UIKEY}" src="{'chevrondown_60.png'|@vtiger_imageurl:$THEME}" width="16" alt="{'LBL_Hide'|@getTranslatedString:'Settings'}" title="{'LBL_Hide'|@getTranslatedString:'Settings'}"/>
										</span>
									{else}
										<span class="exp_coll_block activate">
											<img id="aid{$UIKEY}" src="{'chevronright_60.png'|@vtiger_imageurl:$THEME}" width="16" alt="{'LBL_Show'|@getTranslatedString:'Settings'}" title="{'LBL_Show'|@getTranslatedString:'Settings'}"/>
										</span>
									{/if}
								</a>
							</span>
