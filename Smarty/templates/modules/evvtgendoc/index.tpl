...
<tr><td style="padding:18px;"><div class="slds-form-element" style="width:30%;">
  <label class="slds-form-element__label" for="select-01">
    <abbr class="slds-required" title="required"></abbr>{$APP.LBL_MODULE}</label>
...
<input type="text" id="recordval_display" name="recordval_display" readonly placeholder="Select" class="slds-input" style="width:22%;" />
&nbsp;
<img id="entity"
...
alt="{'LBL_CLEAR'|@getTranslatedString}" title="{'LBL_CLEAR'|@getTranslatedString}" onClick="this.form.recordval.value=''; this.form.recordval_display.value=''; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
  ...
  <tr><td></td><td><label id="template_error_msg" style="color:black;background-color: black;"></label></td></tr>
  <tr><td></td><td><label id="entity_error_msg" style="color:black;background-color: black;"></label></td></tr>
...
<input type="text" id="gendoctemplate_display" name="gendoctemplate_display" readonly placeholder="Select" class="slds-input" style="width:22%;" />&nbsp;
...
<tr><td style="padding: 18px;"><label class="slds-form-element__label" for="form-element-01">{'LBL_DEBUG'|@getTranslatedString:'evvtgendoc'}</label></td><td><div class="slds-checkbox_add-button">
  <input type="checkbox" class="slds-assistive-text" id="add-checkbox-14" value="add-checkbox-14" checked="" />
