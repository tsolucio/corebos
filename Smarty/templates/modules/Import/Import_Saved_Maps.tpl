...
<span id="delete_map_container" style="display:none;">
	<img valign="absmiddle" src="{'delete.gif'|@vtiger_imageurl:$THEME}" style="cursor:pointer;" onclick="ImportJs.deleteMap('{$FOR_MODULE}');" alt="{'LBL_DELETE'|@getTranslatedString:$FOR_MODULE}" />
</span>