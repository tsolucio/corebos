...
<div id="pickListDependencyList">
	...
	<table border=0 cellspacing=0 cellpadding=5 width=100% class="listTable">
		<tr>
			<td class="colHeader small cblds-p-v--medium" valign=top width=5%>#</td>
			<td class="colHeader small cblds-p-v--medium" valign=top width=25%>{$APP.LBL_MODULE}</td>
			<td class="colHeader small cblds-p-v--medium" valign=top width=30%>{$MOD_PICKLIST.LBL_SOURCE_FIELD}</td>
			<td class="colHeader small cblds-p-v--medium" valign=top width=30%>{$MOD_PICKLIST.LBL_TARGET_FIELD}</td>
			<td class="colHeader small cblds-p-v--medium" valign=top width=10%>{$MOD_PICKLIST.LBL_TOOLS}</td>
		</tr>
