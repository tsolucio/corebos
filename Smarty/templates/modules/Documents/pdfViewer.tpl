<html dir="ltr" mozdisallowselectionprint>
  ...
  <body tabindex="1">
      ...
      <div id="mainContainer">
        ...
        <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
          <div id="secondaryToolbarButtonContainer">
            <button disabled id="secondaryOpenFile" class="secondaryToolbarButton visibleLargeView" title="Open File" tabindex="51" data-l10n-id="open_file">
          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer">
              ...
              <div id="toolbarViewerRight">
                <button disabled disabled id="openFile" class="toolbarButton hiddenLargeView" title="Open File" tabindex="31" data-l10n-id="open_file">
                  <span data-l10n-id="open_file_label">Open</span>
                </button>
        ...
        <div id="viewerContainer" tabindex="0">
          <div id="viewer" class="pdfViewer scrollHorizontal"></div>
        </div>
      </div> <!-- mainContainer -->
    ...
    <script>
      window.onload = () => {
        const scrollHorizontalBtn = document.getElementById("scrollHorizontal");
        setTimeout(() => {
          scrollHorizontalBtn.click();
          const page = document.getElementsByClassName("page")[0];
          window.top.postMessage({width: page?.style.width, height: page?.style.height}, '*')
        }, 1000);
      }
    </script>
  </body>
