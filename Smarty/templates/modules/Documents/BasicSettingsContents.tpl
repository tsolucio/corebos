...
<table border=0 cellspacing=0 cellpadding=5 width="350px" align="" class="dvtContentSpace">
	<tr>
		...
		<td class="colHeader small" align="center">{'Visible'|@getTranslatedString}</td>
	</tr>
	...
	<tr onmouseover="this.className='prvPrfHoverOn'" onmouseout="this.className='prvPrfHoverOff'">
		...
		{else}
			...
			<img src="{'disabled.gif'|@vtiger_imageurl:$THEME}" border="0" align="absmiddle" alt="{'LBL_ENABLE'|@getTranslatedString:'Settings'} {$module.name|@getTranslatedString:$module.name}" title="{'LBL_ENABLE'|@getTranslatedString:'Settings'} {$module.name|@getTranslatedString:$module.name}">
			</a>
		{/if}
		</td>
	</tr>
