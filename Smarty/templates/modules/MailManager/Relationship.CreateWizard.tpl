...
<td>
	...
	<tr>
        ...
        <td class="mailSubHeader cblds-t-align_right" align="right">
			<img src="{'close.gif'|vtiger_imageurl:$THEME}" class="mm_clickable" border=0 onclick="MailManager.mail_associate_create_cancel();">
		</td>
	</tr>
	</table>
	<table border="0" cellspacing="0" cellpadding="5" width="100%" class="small cblds-table-border_sep cblds-table-cellpadding_medium" bgcolor="white">
