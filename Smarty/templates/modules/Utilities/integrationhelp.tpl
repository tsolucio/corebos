...
<div class="slds-grid slds-gutters">
	<div class="slds-col">
		...
		<li><div class="slds-box"><a href="index.php?action=integration&module=Utilities&_op=getconfigsmtp">{'SMTP Configuration'|@getTranslatedString:'Utilities'}</a></div></li>
		</ul>
	</div>
	<div class="slds-col">
		<ul class="slds-list_vertical slds-m-left_large slds-m-right_large">
