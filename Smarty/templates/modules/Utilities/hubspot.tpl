...
<div class="slds-modal__container slds-p-around_none">
	...
	<div class="slds-modal__content slds-app-launcher__content slds-p-around_medium">
		<div class="">
			<div class="slds-notify slds-notify_alert slds-theme-alert-texture" role="alert">
			<h2>
		...
		<div class="slds-form-element">
			...
			<span class="slds-form-element__label slds-m-bottom_none">{'hubspot_active'|@getTranslatedString:$MODULE}</span>
		...
		<div class="slds-form-element slds-m-top_small">
			<label class="slds-checkbox_toggle slds-grid">
			<span class="slds-form-element__label slds-m-bottom_none">{'hubspot_mssync'|@getTranslatedString:$MODULE}</span>
			<input type="checkbox" name="hubspot_mssync" aria-describedby="toggle-mssync" {if $mssyncActive}checked{/if} />
			<span id="toggle-mssync" class="slds-checkbox_faux_container" aria-live="assertive">
				<span class="slds-checkbox_faux"></span>
				<span class="slds-checkbox_on">{'LBL_ENABLED'|@getTranslatedString:'Settings'}</span>
				<span class="slds-checkbox_off">{'LBL_DISABLED'|@getTranslatedString:'Settings'}</span>
			</span>
