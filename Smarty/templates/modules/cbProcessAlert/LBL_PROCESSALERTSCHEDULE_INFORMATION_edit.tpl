		...
		<td valign="top">
			<div id="scheduleBox" style="margin-left: 50px;margin-top: 8px;">
				...
				<div id='scheduleByDate' style="padding:5px 0px;clear:both;display:{if $workflow->schtypeid eq 4 || $workflow->schtypeid eq 7}block{else}none{/if};">
					...
					<div style='margin-left:6px;float:left;'>
						<input type="text" name="schdate" id="schdate" style="width:90px;vertical-align: top;" value="{$schdate}"><img border=0 src="{$IMAGE_PATH}btnL3Calendar.gif" alt="{'LBL_SET_DATE'|@getTranslatedString:'Settings'}" title="{'LBL_SET_DATE'|@getTranslatedString:'Settings'}" id="jscal_trigger_schdate">
