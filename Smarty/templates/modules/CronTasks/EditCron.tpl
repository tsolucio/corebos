...
<tr>
	<td class="layerPopupHeading cblds-p--medium" align="left">{$CRON_DETAILS.label}</td>
...
<tr>
	...
	<tr>
		<td align="right" class="cellLabel small cblds-t-align--right" width="40%"><b>{$MOD.LBL_STATUS} :</b></td>
	...
	<tr>
		<td align="right" class="cellLabel small cblds-t-align--right"><b>{$MOD.LBL_FREQUENCY}</b></td>
