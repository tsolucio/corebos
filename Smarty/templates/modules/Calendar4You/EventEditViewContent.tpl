					...
					<table border=0 cellspacing=0 cellpadding=0 width=100%>
					  <tr>
					     <td style="padding:10px">
							...
							<tr>
								<td class="cellLabel" nowrap  width=20% align="right"><b>{$CMOD.LBL_EVENTTYPE}</b></td>
...
<!--										{foreach key=tyeparrkey item=typearr from=$ACTIVITYDATA.activitytype}
							...
							{/if}
							<tr>
								<td class="cellLabel" nowrap align="right"><b><font color="red">{$TYPEOFDATA.subject}</font>{$CMOD.LBL_EVENTNAME}</b></td>
								...
								{foreach key=key_one item=arr from=$ACTIVITYDATA.visibility}
                                                                        ...
                                                                        {/if}
                                                                        {/foreach}
                                                                        <input name="visibility" value="Public" type="checkbox" {$visiblecheck}>{$CMOD.LBL_PUBLIC}
								{/if}
								</td>
							</tr>
							...
							<tr>
			                     <td class="cellLabel" align="right" valign="top"><b><font color="red">{$TYPEOFDATA.location}</font>{$CMOD.LBL_APP_LOCATION}</b></td>
							...
							<tr>
								<td >
									...
									<tr><td width=50% id="date_table_firsttd" valign=top style="border-right:1px solid #dddddd">
										<table border=0 cellspacing=0 cellpadding=2 width=100% align=center>
											<tr><td colspan=3 ><b>{$CMOD.LBL_EVENTSTAT}</b></td></tr>
										...
										<td width=50% valign=top id="date_table_secondtd">
											<table border=0 cellspacing=0 cellpadding=2 width=100% align=center>
												<tr><td colspan=3><b>{$CMOD.LBL_EVENTEDAT}</b></td></tr>
												...
												<tr><td>
													...
													{assign var=time_val value="$time_value"}
													{/foreach}
													<input type="text" name="due_date" id="jscal_field_due_date" class="textbox" style="width:90px" value="{$date_val}"></td><td width=100%><img border=0 src="{$IMAGE_PATH}btnL3Calendar.gif" alt="{$CMOD.LBL_SET_DATE}" title="{$CMOD.LBL_SET_DATE}" id="jscal_trigger_due_date">
										...
										<td width=33% valign=top style="display:none;border-left:1px solid #dddddd" id="date_table_thirdtd">
                                                                                        <table border=0 cellspacing=0 cellpadding=2 width=100% align=center>
                                                                                                <tr><td colspan=3><b><input type="checkbox" name="followup"><b>{$CMOD.LBL_HOLDFOLLOWUP}</b></td></tr>
								...
								<!-- Invite UI -->
											...
											<td valign=top>
												<table border=0 cellspacing=0 cellpadding=2 width=100%>
													<tr><td colspan=3>
														...
														<li>{$CMOD.LBL_INVITE_INST1}
														<li>{$CMOD.LBL_INVITE_INST2}
														</ul>
													</td></tr>
													<tr>
														<td><b>{$CMOD.LBL_AVL_USERS}</b></td>
														<td>&nbsp;</td>
														<td><b>{$CMOD.LBL_SEL_USERS}</b></td>
													</tr>
													<tr>
														...
														<input type=button value="{$CMOD.LBL_ADD_BUTTON} >>" class="crm button small save" style="width:100%"  onClick="incUser('availableusers','selectedusers')"><br>
														<input type=button value="<< {$CMOD.LBL_RMV_BUTTON} " class="crm button small cancel" style="width:100%" onClick="rmvUser('selectedusers')">
														</td>
														<td width=40% align=center valign=top>
														...
														<div align=left> {$CMOD.LBL_SELUSR_INFO}
														</div>
														</td>
													</tr>
												</table>
									...
									{if $LABEL.reminder_time neq ''}
										...
										<DIV id="reminderOptions" {$reminstyle}>
											<table border=0 cellspacing=0 cellpadding=2  width=100%>
												<tr>
													<td nowrap align=right width=20% valign=top><b>{$CMOD.LBL_RMD_ON} : </b></td>
													<td width=80%>
														<table border=0>
														<tr>
															<td colspan=2>
										...
										<tr>
											...
											<td nowrap width=80% valign=top>
												...
												<tr>
													...
													<option value="Daily" {if $ACTIVITYDATA.eventrecurringtype eq 'Daily'} selected {/if}>{$CMOD.LBL_DAYS}</option>
													<option value="Weekly" {if $ACTIVITYDATA.eventrecurringtype eq 'Weekly'} selected {/if}>{$CMOD.LBL_WEEKS}</option>
												<option value="Monthly" {if $ACTIVITYDATA.eventrecurringtype eq 'Monthly'} selected {/if}>{$CMOD.LBL_MONTHS}</option>
													<option value="Yearly" {if $ACTIVITYDATA.eventrecurringtype eq 'Yearly'} selected {/if}>{$CMOD.LBL_YEAR}</option>
													</select>
													<!-- Repeat Feature Enhanced -->
													<b>{$CMOD.LBL_UNTIL}</b> <input type="text" name="calendar_repeat_limit_date" id="calendar_repeat_limit_date" class="textbox" style="width:90px" value="" ></td><td align="left"><img border=0 src="{$IMAGE_PATH}btnL3Calendar.gif" alt="{$CMOD.LBL_SET_DATE}..." title="{$CMOD.LBL_SET_DATE}..." id="jscal_trigger_calendar_repeat_limit_date">
													{literal}
														<script type="text/javascript">
...
{literal}, showsTime : false, button : "jscal_trigger_calendar_repeat_limit_date", singleClick : true, step : 1})</script>
												...
												<table border=0 cellspacing=0 cellpadding=2>
												<tr>
													<td><input name="sun_flag" value="sunday" {$ACTIVITYDATA.week0} type="checkbox"></td><td>{$CMOD.LBL_SM_SUN}</td>
													<td><input name="mon_flag" value="monday" {$ACTIVITYDATA.week1} type="checkbox"></td><td>{$CMOD.LBL_SM_MON}</td>
													<td><input name="tue_flag" value="tuesday" {$ACTIVITYDATA.week2} type="checkbox"></td><td>{$CMOD.LBL_SM_TUE}</td>
													<td><input name="wed_flag" value="wednesday" {$ACTIVITYDATA.week3} type="checkbox"></td><td>{$CMOD.LBL_SM_WED}</td>
													<td><input name="thu_flag" value="thursday" {$ACTIVITYDATA.week4} type="checkbox"></td><td>{$CMOD.LBL_SM_THU}</td>
													<td><input name="fri_flag" value="friday" {$ACTIVITYDATA.week5} type="checkbox"></td><td>{$CMOD.LBL_SM_FRI}</td>
													<td><input name="sat_flag" value="saturday" {$ACTIVITYDATA.week6} type="checkbox"></td><td>{$CMOD.LBL_SM_SAT}</td>
												</tr>
												</table>
												</div>
												...
												<tr>
													<td>
														...
														<select name="repeatMonth_day">
															<option value=1 {if $ACTIVITYDATA.repeatMonth_day eq 1} selected {/if}>{$CMOD.LBL_DAY1}</option>
															<option value=2 {if $ACTIVITYDATA.repeatMonth_day eq 2} selected {/if}>{$CMOD.LBL_DAY2}</option>
															<option value=3 {if $ACTIVITYDATA.repeatMonth_day eq 3} selected {/if}>{$CMOD.LBL_DAY3}</option>
															<option value=4 {if $ACTIVITYDATA.repeatMonth_day eq 4} selected {/if}>{$CMOD.LBL_DAY4}</option>
															<option value=5 {if $ACTIVITYDATA.repeatMonth_day eq 5} selected {/if}>{$CMOD.LBL_DAY5}</option>
															<option value=6 {if $ACTIVITYDATA.repeatMonth_day eq 6} selected {/if}>{$CMOD.LBL_DAY6}</option>
														</select>
														</td>
														</tr>
														</table>
		...
		<table border="0" cellpadding="5" cellspacing="0" width="100%">
			<tr>
                        	<td class="cellLabel" width="20%" align="right"><b><font color="red">{$TYPEOFDATA.subject}</font>{$CMOD.LBL_TODO}</b></td>
			...
			<tr><td width=50% valign=top>
				<table border=0 cellspacing=0 cellpadding=2 width=100% align=center >
					<tr><td colspan=3  class="mailSubHeader"><b>{$CMOD.LBL_TODODATETIME}</b></td></tr>
					<tr><td colspan=3>{$STARTHOUR}</td></tr>
					<tr><td>
							{foreach key=date_value item=time_value from=$ACTIVITYDATA.date_start}
	                                        		{assign var=date_val value="$date_value"}
								{assign var=time_val value="$time_value"}
                                        		{/foreach}
							<input name="date_start" id="date_start" class="textbox" style="width: 90px;" onChange="dochange('date_start','due_date');" value="{$date_val}" type="text"></td><td width=100%><img src="{$IMAGE_PATH}btnL3Calendar.gif" alt="{$CMOD.LBL_SET_DATE}" title="{$CMOD.LBL_SET_DATE}" id="jscal_trigger_date_start" align="middle" border="0">
							{foreach key=date_fmt item=date_str from=$secondvalue.date_start}
								{assign var=date_vl value="$date_fmt"}
							{/foreach}
							<script type="text/javascript">
					...
					<td width=50% valign="top">
							...
							<tr><td>
								{foreach key=date_value item=time_value from=$ACTIVITYDATA.due_date}
									...
									{assign var=time_val value="$time_value"}
								{/foreach}
								<input name="due_date" id="due_date" class="textbox" style="width: 90px;" value="{$date_val}" type="text"></td><td width=100%><img src="{$IMAGE_PATH}btnL3Calendar.gif" alt="{$CMOD.LBL_SET_DATE}" title="{$CMOD.LBL_SET_DATE}" id="jscal_trigger_due_date" border="0">
								{foreach key=date_fmt item=date_str from=$secondvalue.due_date}
                                                			{assign var=date_vl value="$date_fmt"}
                                        			{/foreach}
				      				<script type="text/javascript">
		...
		<table align="center" border="0" cellpadding="0" cellspacing="0" width="95%" bgcolor="#FFFFFF">
			...
			<div id="addTaskRelatedtoUI" style="display:{$vision};width:100%">
			     ...
			     {if $LABEL.parent_id neq ''}
                	     <tr>
                        	     <td><b><font color="red">{$TYPEOFDATA.parent_id}</font>{$CMOD.LBL_RELATEDTO}</b></td>
                                     <td>
					<input name="parent_id" type="hidden" value="{$secondvalue.parent_id}">
					<input name="del_actparent_rel" type="hidden" >
                                             <select name="parent_type" class="small" id="parent_type" onChange="document.EditView.parent_name.value='';document.EditView.parent_id.value=''">
...
{if $ACTIVITY_MODE eq 'Task'}
	var fieldname = new Array('subject','date_start','time_start','due_date','taskstatus');
        var fieldlabel = new Array('{$CMOD.LBL_LIST_SUBJECT}','{$CMOD.LBL_START_DATE}','{$CMOD.LBL_TIME}','{$CMOD.LBL_DUE_DATE}','{$CMOD.LBL_STATUS}');
...
{else}
	var fieldname = new Array('subject','date_start','time_start','due_date','eventstatus','taskpriority','sendnotification','parent_id','contact_id','reminder_time','recurringtype');
        var fieldlabel = new Array('{$CMOD.LBL_LIST_SUBJECT}','{$CMOD.LBL_START_DATE}','{$CMOD.LBL_TIME_START}','{$CMOD.LBL_DUE_DATE}','{$CMOD.LBL_STATUS}','{$CMOD.Priority}','{$CMOD.LBL_SENDNOTIFICATION}','{$CMOD.LBL_RELATEDTO}','{$CMOD.LBL_CONTACT_NAME}','{$CMOD.LBL_SENDREMINDER}','{$CMOD.Recurrence}');
