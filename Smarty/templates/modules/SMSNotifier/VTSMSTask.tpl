...
<table border="0" cellpadding="5" cellspacing="0" width="100%" class="small">
	<tr>
		...
		<select id="task_phonefields" class="small" style="display: none;">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="small">
	<tr>
		<td style='padding-top: 10px;'><span id="task-fieldnames-busyicon"><b>{$MOD.LBL_LOADING}</b><img src="{'vtbusy.gif'|@vtiger_imageurl:$THEME}" border="0"></span>
		<select id="sms_fieldnames" class="small" style="display: none;">
			<option value=''>{$MOD.LBL_SELECT_OPTION_DOTDOTDOT}</option>
		</select></td>
	</tr>
</table>
