	...
	{elseif $keyid eq '33' || $keyid eq '3313' || $keyid eq '3314'}<!--Multi Select Combo box-->
					...
					{/foreach}
						...
						{/if}
							...
							{/if}
                                             {elseif $keyid eq '24' || $keyid eq '22'} <!--TextArea/Street-->
                                             ...
                                             {elseif $keyid eq '21'} <!--TextArea/Street for Signature-->
                                                  <td width=25% class="dvtCellInfo" align="left" id="mouseArea_{$keyfldname}">&nbsp;<span id="dtlview_{$keyfldname}" style="word-break:break-word;">{$keyval|unescape:"html"}</span></td>
