	...
	<tbody>
		...
		<tr>
			...
			<td style="padding-left: 5px;" align="left" height="50" valign="bottom" width="75%">
				<input type="radio" name="reportType" id="tabular" value="tabular" onChange="hideTabs()">
				<b> {$MOD.LBL_TABULAR_FORMAT}</b>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 25px;" align="left" valign="top" width="75%">
