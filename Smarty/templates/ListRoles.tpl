...
<tbody><tr>
	...
	<td class="showPanelBg" style="padding: 10px;" valign="top" width="100%">
		...
		<br>
				...
				<tr>
					<td width=50 rowspan=2 valign=top class="cblds-p--none"><img src="{'ico-roles.gif'|@vtiger_imageurl:$THEME}" alt="{$MOD.LBL_ROLES}" width="48" height="48" border=0 title="{$MOD.LBL_ROLES}"></td>
				...
				<tr>
					<td valign=top class="small cblds-p-v--none">{$MOD.LBL_ROLE_DESCRIPTION}</td>
				</tr>
				</table>
				<br>
