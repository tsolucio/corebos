                                    ...
                                    <table border="0" cellpadding="5" cellspacing="0" width="100%">
                                      <tbody><tr>
                                        <td><table class="small" border="0" cellpadding="5" cellspacing="0" width="100%">
                                            <tbody><tr>
                                              <td class="cblds-p--none"><!-- Module name heading -->
                                                  <table class="small" border="0" cellpadding="2" cellspacing="0">
                                                    <tbody><tr>
                                                      <td valign="top" class="cblds-p--none"><img src="{'prvPrfHdrArrow.gif'|@vtiger_imageurl:$THEME}"> </td>
                                                      <td class="prvPrfBigText cblds-p--none"><b> {if $MODE eq 'create'}{$CMOD.LBL_STEP_2_2} : {/if}{$CMOD.LBL_DEFINE_PRIV_FOR} &lt;{$PROFILE_NAME}&gt; </b><br>
                                                      <font class="small">{$CMOD.LBL_USE_OPTION_TO_SET_PRIV}</font> </td>
                                                      <td class="small cblds-p--none" style="padding-left: 10px;" align="right"></td>
                                                    </tr>
                                                </tbody></table></td>
                                              <td class="cblds-t-align--right" align="right" valign="bottom">&nbsp;
						...
						<table class="small" align="center" border="0" cellpadding="5" cellspacing="0" width="90%">
                                                <tbody><tr>
                                                    ...
                                                    <td valign="top" width="97%"><table class="small" border="0" cellpadding="2" cellspacing="0" width="100%">
                                                      <tbody>
				                         <tr id="gva">
                                                          <td class="cblds-p--none" valign="top">{$GLOBAL_PRIV.0}</td>
                                                          <td class="cblds-p--none"><b>{$CMOD.LBL_VIEW_ALL}</b> </td>
                                                        </tr>
                                                        <tr>
                                                          <td class="cblds-p--none" valign="top"></td>
                                                          <td class="cblds-p--none" width="100%" >{$CMOD.LBL_ALLOW} "{$PROFILE_NAME}" {$CMOD.LBL_MESG_VIEW}</td>
                                                        </tr>
                                                        <tr>
                                                          <td>&nbsp;</td>
                                                        </tr>
							<tr>
							<td class="cblds-p--none" valign="top">{$GLOBAL_PRIV.1}</td>
							<td class="cblds-p--none"><b>{$CMOD.LBL_EDIT_ALL}</b> </td>
							</tr>
                                                        <tr>
                                                          <td class="cblds-p--none"valign="top"></td>
                                                          <td class="cblds-p--none"> {$CMOD.LBL_ALLOW} "{$PROFILE_NAME}" {$CMOD.LBL_MESG_EDIT}</td>
                                                        </tr>
...
<br>
			...
			<table class="small" align="center" border="0" cellpadding="5" cellspacing="0" width="90%">
			  <tbody><tr>
				...
				<table class="small listTable" border="0" cellpadding="5" cellspacing="0" width="100%">
			        <tbody>
				<tr id="gva">
			          <td colspan="7" class="small colHeader cblds-p-v--mediumsmall"><div align="center"><strong>{$CMOD.LBL_EDIT_PERMISSIONS}</strong></div></td>
			        </tr>
			        <tr id="gva">
			          <td colspan="2" class="small colHeader cblds-p-v--mediumsmall"><strong> {$CMOD.LBL_TAB_MESG_OPTION} </strong><strong></strong></td>
			          <td class="small colHeader cblds-p-v--mediumsmall"><div align="center"><strong>{$CMOD.LBL_CREATE}</strong></div></td>
			          <td class="small colHeader cblds-p-v--mediumsmall"><div align="center"><strong>{$CMOD.Edit}</strong></div></td>
			          <td class="small colHeader cblds-p-v--mediumsmall"> <div align="center"><strong>{$CMOD.LBL_VIEW}</strong></div></td>
			          <td class="small colHeader cblds-p-v--mediumsmall"> <div align="center"><strong>{$CMOD.LBL_DELETE}</strong></div></td>
			          <td class="small colHeader cblds-p-v--mediumsmall" nowrap="nowrap">{$CMOD.LBL_FIELDS_AND_TOOLS_SETTINGS}</td>
			        </tr>
				...
				{/if}
						...
						<tr>
							{if $modulename eq 'Calendar'}
								<td class="small colHeader cblds-p-v--mediumsmall" colspan="7" valign="top">{$CMOD.LBL_FIELDS_TO_BE_SHOWN} ({$APP.Tasks})</td>
							{else}
								<td class="small colHeader cblds-p-v--mediumsmall" colspan="7" valign="top">{$CMOD.LBL_FIELDS_TO_BE_SHOWN}</td>
							{/if}
					        </tr>
		...
		<table border="0" cellpadding="2" cellspacing="0">
			<tr>
				<td align="left" class="cblds-p--none"><font color="red" size=5>*</font>{$CMOD.LBL_MANDATORY_MSG}</td>
			</tr>
			<tr>
				<td align="left" class="cblds-p--none"><font color="blue" size=5>*</font>{$CMOD.LBL_DISABLE_FIELD_MSG}</td>
			</tr>
		</table>
		<tr>
