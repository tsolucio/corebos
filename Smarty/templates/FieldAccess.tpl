...
<tbody><tr>
	...
	{include file='SetMenu.tpl'}
		...
		{/if}
		<tr>
			<td width=50 rowspan=2 valign=top class="cblds-p--none"><img src="{'orgshar.gif'|@vtiger_imageurl:$THEME}" alt="{$MOD.LBL_MODULE_NAME}" width="48" height="48" border=0 title="{$MOD.LBL_MODULE_NAME}"></td>
		...
		<tr>
			<td valign=top class="small cblds-p-v--none">{$MOD.LBL_SHARING_FIELDS_DESCRIPTION}</td>
		</tr>
		</table>
		<br>
