					...
					<td width="50%" valign=top>
						<form  name="Export_Records"  method="POST" onsubmit="VtigerJS_DialogBox.block();">
							...
							<table align="center" cellpadding="15" cellspacing="0" width="85%" class="mailClient importLeadUI small" border="0">
								<tr>
									<td colspan="2" valign="middle" align="left" class="mailClientBg genHeaderSmall cblds-p--x-large">{$MODULELABEL} >> {$APP.LBL_EXPORT} </td>
									<br>
								</tr>
								<tr>
									<td border="0" cellpadding="5" cellspacing="0" width="50%" class="cblds-p--large">
										<table>
											<tr>
								...
								<tr>
									<td align="center" colspan="2" border=0 cellspacing=0 cellpadding=5 width=98% class="layerPopupTransport cblds-p--large cblds-t-align--center">
