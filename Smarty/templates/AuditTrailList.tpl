				...
				<div align=center>
					...
					<table border=0 cellspacing=0 cellpadding=5 width=100% class="settingsSelUITopLine">
						<tr>
							...
							<td class=heading2 valign=bottom><b><a href="index.php?module=Settings&action=index&parenttab=Settings">{'LBL_SETTINGS'|@getTranslatedString}</a> > {$MOD.LBL_AUDIT_TRAIL}</b></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<table border=0 cellspacing=0 cellpadding=5 width=100% class="tableHeading">
								<tr>
									...
									<td class="small" align="center" width="30%">&nbsp; <span id="audit_info" class="crmButton small cancel" style="display:none;"></span></td>
								</tr>
							</table>
								...
								<tr>
									...
									<table width="100%"  border="0" cellspacing="0" cellpadding="5">
										<tr>
											...
											<td width="80%" class="small cellText"> {if $AuditStatus eq 'enabled'}
											<input type="checkbox" checked name="enable_audit" onclick="auditenabled(this)">
											</input> {else}
											<input type="checkbox" name="enable_audit" onclick="auditenabled(this)">
											</input> {/if} </td>
										</tr>
										<tr valign="top">
