										...
										<!-- td --> <!-- SetMenu.tpl -->
											<form id="modulefrom" action="index.php" method="POST">
												...
												<table class="settingsSelUITopLine" border="0" cellpadding="5" cellspacing="0" width="100%">
													<tbody>
														<tr>
															<td rowspan="2" valign="top" width="50"><img src="{$IMAGE_PATH}languages.gif" alt="Language Translation" title="Language Translation" border="0" height="48" width="48"></td>
												...
												<div style="text-align:right;margin:3px;">
													...
													{$UMOD.LBL_TRADE_PERCENTAGE} <strong>{$PERC_TRANSALTED}</strong>
                                                                                                        <input value="{$APP.LBL_ADD_BUTTON_LABEL}" class="crmButton small save" onclick="addLabel();" type="button"/>
												...
												<div id="basicTab" style="width:100%;height:500px;overflow:auto;">
