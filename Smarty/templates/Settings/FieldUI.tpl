...
{if $_FIELD_UI_TYPE eq 56}
	<input id="{$_FIELD_ELEMENT_ID}" name="{$_FIELD_ELEMENT_ID}" type="checkbox" class="slds-input" {if $_FIELD_SELECTED_VALUE eq 1}checked{/if}>
{elseif $_FIELD_UI_TYPE eq 23 || $_FIELD_UI_TYPE eq 5 || $_FIELD_UI_TYPE eq 6}
	<input class="slds-input" id="{$_FIELD_ELEMENT_ID}" name="{$_FIELD_ELEMENT_ID}" type="text" size="11" maxlength="10" value="{if $_FIELD_SELECTED_VALUE neq 0}{$_FIELD_SELECTED_VALUE}{/if}">
...
{elseif $_FIELD_UI_TYPE eq 15 || $_FIELD_UI_TYPE eq 16 || $_FIELD_UI_TYPE eq 33}
	<select id="{$_FIELD_ELEMENT_ID}" name="{$_FIELD_ELEMENT_ID}" class="slds-select">
		{foreach item=_PICKLIST_VALUE from=$_ALL_AVAILABLE_VALUES}
			<option value="{$_PICKLIST_VALUE}" {if $_PICKLIST_VALUE eq $_FIELD_SELECTED_VALUE} selected {/if}>
...
{else}
	<input id="{$_FIELD_ELEMENT_ID}" name="{$_FIELD_ELEMENT_ID}" type="text" class="slds-input" value="{$_FIELD_SELECTED_VALUE}" />
{/if}