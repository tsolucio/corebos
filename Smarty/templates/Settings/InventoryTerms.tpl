	...
	<div align=center>
			...
			{include file="SetMenu.tpl"}
				...
				<tr>
					...
					<td class=heading2 valign=bottom><b><a href="index.php?module=Settings&action=index&parenttab=Settings">{'LBL_SETTINGS'|@getTranslatedString}</a> > {$MOD.INVENTORYTERMSANDCONDITIONS} </b></td>
				</tr>
				<tr>
