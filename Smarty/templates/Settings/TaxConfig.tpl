...
<table border=0 cellspacing=0 cellpadding=5 width=100% class="settingsSelUITopLine">
	<tr>
	<td width=50 rowspan=2 valign=top class="cblds-p--none"><img src="{'taxConfiguration.gif'|@vtiger_imageurl:$THEME}" alt="{$MOD.LBL_USERS}" width="48" height="48" border=0 title="{$MOD.LBL_USERS}"></td>
	...
	<tr>
	<td valign=top class="small cblds-p-v--none">{$MOD.LBL_TAX_DESC}</td>
	</tr>
</table>
...
<table border=0 cellspacing=0 cellpadding=10 width=100%>
	...
	<td style="border-right:1px dotted #CCCCCC;" valign="top">
		...
		<table border=0 cellspacing=0 cellpadding=5 width=100% class="tableHeading">
			...
			<tr>
			<td>&nbsp;</td>
			<td id="td_add_tax" class="small cblds-t-align--right" colspan="2" align="right" nowrap>
			...
			<td class="small cblds-t-align--right" align=right nowrap>
			{if $EDIT_MODE eq 'true'}
	...
	<td width="50%" valign="top">
		...
		<table border=0 cellspacing=0 cellpadding=5 width=100% class="tableHeading">
			...
			<tr>
			<td>&nbsp;</td>
				<td id="td_sh_add_tax" class="small cblds-t-align--right" colspan="2" align="right" nowrap>
