			...
			<label class="slds-form-element__label"> {'LBL_SELECT'|@getTranslatedString} </label>
				<div class="slds-form-element__control slds-input-has-fixed-addon">
					<input id="bmapid" name="bmapid" class="slds-input" type="hidden" value="{$task->bmapid}">
						<input id="bmapid_display" class="slds-input" name="bmapid_display" readonly="" style="border:1px solid #bababa;" type="text" value="{$task->bmapid_display}" onclick="return window.open('index.php?module=cbMap&action=Popup&html=Popup_picker&form=new_task&forfield=bmapid&srcmodule=GlobalVariable'+SpecialSearch,'vtlibui10wf','width=1680,height=850,resizable=0,scrollbars=0,top=150,left=200');">
