...
<div class="slds-form-element slds-m-top--small">
	<label class="slds-form-element__label" for="save_encoded_value">{'LBL_WHERE_TO_SAVE'|@getTranslatedString:$MODULE}</label>
	<div class="slds-form-element__control">
		<select id="save_encoded_value" name="save_encoded_value" class="slds-input">
			<option value=''>{'Select Field to Save Encoded Value'|@getTranslatedString:$MODULE}</option>
		</select>
	</div>
</div>
{* Field with Value to Encode Input Element *}
<div class="slds-form-element slds-m-top--small">
	<label class="slds-form-element__label" for="">{'LBL_WHAT_TO_ENCODE'|@getTranslatedString:$MODULE}</label>
	<div class="slds-form-element__control">
		<select id="field_to_encode" name="field_to_encode" class="slds-input">
			<option value=''>{'Select Field to Encode'|@getTranslatedString:$MODULE}</option>
		</select>
	</div>
</div>
{* Field to Select Encode Type Input Element *}
<div class="slds-form-element slds-m-top--small">
	<label class="slds-form-element__label" for="LBL_ENCODE_FORMAT">{'Encoding Type'|@getTranslatedString:$MODULE}</label>
	<div class="slds-form-element__control">
		<select id="encoding_type" name="encoding_type" class="slds-input">
			<option value=''>{'Select Encoding Type'|@getTranslatedString:$MODULE}</option>
