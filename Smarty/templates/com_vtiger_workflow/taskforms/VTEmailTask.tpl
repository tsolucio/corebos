...
<div class="slds-grid slds-grid_vertical-align-center slds-p-horizontal_xx-large">
	...
	<div class="slds-col slds-size_4-of-12 slds-p-around_x-small">
		...
		<div class="slds-grid">
			<div class="slds-col">
				<input class="slds-button slds-button_success" title="{$APP.LBL_SELECTEMAILTEMPLATE_BUTTON_TITLE}" accessKey="{$APP.LBL_SELECTEMAILTEMPLATE_BUTTON_KEY}" onclick="jQuery('#file-uploader').show();return vtlib_open_popup_window('','msgtpopup','MsgTemplate','{$workflow->moduleName}');" type="button" name="button" value=" {$APP.LBL_SELECTEMAILTEMPLATE_BUTTON_LABEL}"/>
			</div>
			<div class="slds-col">
