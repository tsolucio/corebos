...
<table border="0" cellpadding="5" cellspacing="0" width="100%" class="small">
	<tr>
		...
		<td class='dvtCellInfo'><input type="text" name="fromname" value="{if isset($task->fromname)}{$task->fromname}{/if}" id="save_fromname" class="form_input" style='width: 250px;'>
	...
	<tr>
		...
		<td class='dvtCellInfo'><input type="text" name="fromemail" value="{if isset($task->fromemail)}{$task->fromemail}{/if}" id="save_fromemail" class="form_input" style='width: 250px;'>
	...
	<tr>
		...
		<td class='dvtCellInfo'><input type="text" name="replyto" value="{if isset($task->replyto)}{$task->replyto}{/if}" id="save_replyto" class="form_input" style='width: 250px;'>
	...
	<tr>
		...
		<td class='dvtCellInfo'><input type="text" name="recepient" value="{if isset($task->recepient)}{$task->recepient}{/if}" id="save_recepient" class="form_input" style='width: 250px;'>
	...
	<tr>
		...
		<td class='dvtCellInfo'><input type="text" name="emailcc" value="{if isset($task->emailcc)}{$task->emailcc}{/if}" id="save_emailcc" class="form_input" style='width: 250px;'>
	...
	<tr>
		...
		<td class='dvtCellInfo'><input type="text" name="emailbcc" value="{if isset($task->emailbcc)}{$task->emailbcc}{/if}" id="save_emailbcc" class="form_input" style='width: 250px;'>
	...
	<tr>
		...
		<td class='dvtCellInfo'><input type="text" name="subject" value="{if isset($task->subject)}{$task->subject}{/if}" id="save_subject" class="form_input" style='width: 350px;'>
