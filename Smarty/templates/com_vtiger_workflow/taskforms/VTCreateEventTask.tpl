...
<div id="view">
	...
	<tr valign="top">
		<td class='dvtCellLabel' align="right" width=15% nowrap="nowrap"><b>{$MOD.LBL_TYPE}</b></td>
		<td class='dvtCellInfo'>
	...
	<tr>
		<td align="right"><b>{$MOD.LBL_START_TIME}</b></td>
	...
	<tr>
		<td align="right"><b>{$MOD.LBL_START_DATE}</b></td>
		<td>
	...
	<tr>
		<td align="right"><b>{$MOD.LBL_END_TIME}</b></td>
		{if $task->endTime neq ''}
	...
	<tr>
		<td align="right"><b>{$MOD.LBL_END_DATE}</b></td>
