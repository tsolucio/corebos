...
<button name="cancel" id='editpopup_cancel' type="button" onClick="hide('selectfunction');" class="slds-button slds-button_destructive" >{$APP.LBL_CANCEL_BUTTON_LABEL}</button>
