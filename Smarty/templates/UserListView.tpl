...
<input type='hidden' name='parenttab' value='Settings'>
	...
	<div align=center>
			{include file='SetMenu.tpl'}
				...
				<tr>
					<td width=50 rowspan=2 valign=top class="cblds-p--none"><img src="{'ico-users.gif'|@vtiger_imageurl:$THEME}" alt="{$MOD.LBL_USERS}" width="48" height="48" border=0 title="{$MOD.LBL_USERS}"></td>
				...
				<tr>
					<td valign=top class="small cblds-p-v--none">{$MOD.LBL_USER_DESCRIPTION}</td>
				</tr>
				</table>
