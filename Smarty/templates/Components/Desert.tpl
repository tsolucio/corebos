...
DESERTInfo text to show in message
DESERTSize small/large
*}

<div class="slds-illustration slds-illustration_{if isset($DESERTSize)}{$DESERTSize}{else}large{/if} slds-card slds-p-around_xx-large">
...
<h3 class="slds-text-heading_medium">{$DESERTInfo}</h3>
</div>
</div>
