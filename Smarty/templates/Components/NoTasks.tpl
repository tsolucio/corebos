...
NOTASKSInfo text to show in message
NOTASKSSize small/large
*}

<div class="slds-illustration slds-illustration_{if isset($NOTASKSSize)}{$NOTASKSSize}{else}large{/if} slds-card slds-p-around_xx-large">
...
<h3 class="slds-text-heading_medium">{$NOTASKSInfo}</h3>
</div>
</div>
