...
<span id="crmspanid" style="display:none;position:absolute;"  onmouseover="show('crmspanid');">
   ...
   <!-- &nbsp;<a class="link"  align="right" href="javascript:;"><img src="themes/images/search.gif"></a> --><!-- pag 2012-Jan-12 -->
</span>
<!-- pag 2012-Jan-12
<span id="searchid" style="display:none;position:absolute;"  onmouseover="show('searchid');">
   <a class="link"  align="right" href="javascript:;"><img src="themes/images/search.gif"></a> 
</span>
-->
...
{if $MODULE eq 'Accounts' || $MODULE eq 'Contacts' || $MODULE eq 'Leads' || $MODULE eq 'Vendors'}
    ...
    {/if} 
    {if $MODULE eq 'Leads'}
	{assign var=address1 value='$MOD.LBL_ADDRESS_INFORMATION'}
    {/if} 
    {if $MODULE eq 'Vendors'}
	{assign var=address1 value='$MOD.LBL_VENDOR_ADDRESS_INFORMATION'}
    {/if}    
	...
	<table bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<td>
		    ...
		    {/if}    
		    {if $MODULE eq 'Leads'}
			<a href="javascript:;" onClick="fninvsh('locateMap'); searchMapLocation( 'Main' );" class="calMnu">{$MOD.LBL_ADDRESS_INFORMATION}</a>
		    {/if}
		    {if $MODULE eq 'Vendors'}
			<a href="javascript:;" onClick="fninvsh('locateMap'); searchMapLocation( 'Main' );" class="calMnu">{$MOD.LBL_VENDOR_ADDRESS_INFORMATION}</a>
		    {/if}
		</td>
	    </tr>
	</table>
		...
		<tr>
			...
			<div class="small" style="padding:10px" >
				...
				<tr>
					...
					<span class="dvHeaderText">[ {$USE_ID_VALUE} ] {$NAME} -  {$SINGLE_MOD|@getTranslatedString:$MODULE} {$APP.LBL_INFORMATION}</span><span id="vtbusy_info" style="display:none;" valign="bottom"><img src="{'vtbusy.gif'|@vtiger_imageurl:$THEME}" border="0"></span><span id="vtbusy_info" style="visibility:hidden;" valign="bottom"><img src="{'vtbusy.gif'|@vtiger_imageurl:$THEME}" border="0"></span>
					<!-- pag 2011-Dec-02 &nbsp; --><!-- pag 2011-Dec-02 &nbsp; -->&nbsp;<span class="small">{$UPDATEINFO}</span><!-- pag 2011-Dec-02 &nbsp; -->
				    </td>
				</tr>
			    </table>		 	 
			    <br>
				...
				<tr>
					...
					<table border=0 cellspacing=0 cellpadding=3 width=100% class="small">
					    <tr>
						<td class="dvtTabCache" style="width:10px" nowrap><!-- pag 2011-Dec-02 &nbsp; --></td>
						<td class="dvtSelectedCell" align=center nowrap>{$SINGLE_MOD|@getTranslatedString:$MODULE} {$APP.LBL_INFORMATION}</td>	
						<td class="dvtTabCache" style="width:10px"></td>
<!-- SinglePaneView Start -->	
					{if $SinglePane_View eq 'false' && $IS_REL_LIST neq false && $IS_REL_LIST|@count > 0}
						
							{* <!-- ---------------------------------------------- Custom Modification top tabs pag 2012-Jan-25  ------------------------ --> *}
					
							{foreach key=_RELATION_ID item=_RELATED_MODULE from=$IS_REL_LIST name=mi} 
								{if $smarty.foreach.mi.index lt 4}
									<td class="dvtUnSelectedCell" align="center" border="10" padding="10">
										<a href="index.php?action=CallRelatedList&module={$MODULE}&record={$ID}&parenttab={$CATEGORY}&selected_header={$_RELATED_MODULE}">{$_RELATED_MODULE|@getTranslatedString:$MODULE|replace:' ':'&nbsp;'}</a>
									</td>
									<td class="dvtTabCache" style="width:10px"></td>
								{/if}
							{/foreach}
							...
							<div onmouseover="fnShowDrop('More_Information_Modules_List')" onmouseout="fnHideDrop('More_Information_Modules_List')"
								...
								{foreach key=_RELATION_ID item=_RELATED_MODULE from=$IS_REL_LIST name=mi} 
									{if $smarty.foreach.mi.index gt 3}
								    <tr>
									<td>
									    <a class="drop_down" href="index.php?action=CallRelatedList&module={$MODULE}&record={$ID}&parenttab={$CATEGORY}&selected_header={$_RELATED_MODULE}">{$_RELATED_MODULE|@getTranslatedString:$MODULE}</a>
									</td>
								    </tr>
								    {/if}
								{/foreach}
...
<!-- SinglePaneView End -->								
						<td class="dvtTabCache" align="right" style="width:100%">
							...
							<img align="absmiddle" title="{$APP.LBL_JUMP_BTN}" accessKey="{$APP.LBL_JUMP_BTN}" onclick="var obj = this;var lhref = getListOfRecords(obj, '{$MODULE}',{$ID},'{$CATEGORY}');" name="jumpBtnIdTop" id="jumpBtnIdTop" src="{'rec_jump.gif'|@vtiger_imageurl:$THEME}"><!-- pag 2011-Dec-02 &nbsp; -->
						    {/if}
						    {if $nextrecord neq ''}
							<img align="absmiddle" title="{$APP.LNK_LIST_NEXT}" accessKey="{$APP.LNK_LIST_NEXT}" onclick="location.href='index.php?module={$MODULE}&viewtype={$VIEWTYPE}&action=DetailView&record={$nextrecord}&parenttab={$CATEGORY}&start={$nextrecordstart}'" name="nextrecord" src="{'rec_next.gif'|@vtiger_imageurl:$THEME}"><!-- pag 2011-Dec-02 &nbsp; -->
						    {else}
							<img align="absmiddle" title="{$APP.LNK_LIST_NEXT}" src="{'rec_next_disabled.gif'|@vtiger_imageurl:$THEME}"><!-- pag 2011-Dec-02 &nbsp; -->
						    {/if}
						</td>
					    </tr>
					</table>
						...
						<td style="padding:5px">
						    ...
						    <table border=0 cellspacing=0 cellpadding=0 width=100%>
							 ...
							 <form action="index.php" method="post" name="DetailView" id="form">
							    ...
							    <!-- Start of File Include by SAKTI on 10th Apr, 2008 -->
<!-- VENDORS !!! -->
<!-- OK PAG IS HERE! Detailed View Code starts here with Comments Block Widget -->							
								...
								<!-- Detailed View Code starts here with Comments Block -->
								<table border=0 cellspacing=0 cellpadding=0 width=100% class="small">
								    <tr>
									<td><!-- pag 2011-Dec-02 &nbsp; --></td>
									<td><!-- pag 2011-Dec-02 &nbsp; --></td>
									<td><!-- pag 2011-Dec-02 &nbsp; --></td>
									<td align=right>
									    {* <!-- pag 2012-Jan-07 
									    {if $header eq ($MOD.LBL_ADDRESS_INFORMATION || $MOD.LBL_VENDOR_ADDRESS_INFORMATION) && ($MODULE eq 'Accounts' || $MODULE eq 'Contacts' || $MODULE eq 'Leads' || $MODULE eq 'Vendors' ) }
								    ...
								    {*<!-- pag 2011-Nov-21 This is added to display the existing comments -->*}
									...
									<tr>
									    <!-- <td colspan=4 class="dvtCellInfo">{$COMMENT_BLOCK}</td> ??? pag 2012-Jan-12 no effect ??? -->
									</tr>
									<tr><td><!-- pag 2011-Dec-02 &nbsp; --></td></tr>
								    {/if}
								    {*<!-- pag 2011-Nov-21 -->*}
		...
		<td width=22% valign=top style="border-left:1px dashed #cccccc;padding-top:13px" class="noprint"> 
		<table>
		<td valign="top">
			<!-- pag 2012-Jan-07 moved Locate Map to Sidebar-->
			{if $MODULE eq 'Accounts' || $MODULE eq 'Contacts' || $MODULE eq 'Leads' }
				{if $header eq ($MOD.LBL_ADDRESS_INFORMATION)}                          
					<input name="mapbutton" value="{$APP.LBL_LOCATE_MAP}" class="crmbutton small create" type="button" onClick="searchMapLocation('Main')" title="{$APP.LBL_LOCATE_MAP}">
				{else}
                    <input name="mapbutton" value="{$APP.LBL_LOCATE_MAP}" class="crmbutton small create" type="button" onClick="fnvshobj(this,'locateMap');" onMouseOut="fninvsh('locateMap');" title="{$APP.LBL_LOCATE_MAP}">       
				{/if}
			{/if}
			<!-- END pag 2012-Jan-07 moved Locate Map to Sidebar-->
		</td>
	</td>

			<!-- pag 2012-Jan-12 move Hierarchies to Top of Sidebar-->
			<!-- THIS IS HIERARCHY !!! -->
			...
			{if $CUSTOM_LINKS && $CUSTOM_LINKS.DETAILVIEWBASIC}
				...
				{if $CUSTOMLINK->linklabel eq 'LBL_SHOW_ACCOUNT_HIERARCHY' || $CUSTOMLINK->linklabel eq 'LBL_SHOW_CONTACT_HIERARCHY' || $CUSTOMLINK->linklabel eq 'LBL_SHOW_LEAD_HIERARCHY'}
				<!-- <tr> -->
					<td valign="top" >
						...
						<a href="{$customlink_href}"><input value="{$customlink_label}" class="crmbutton small create" type="button"></a>
						<!-- <a  class="crmbutton small create" type "button" href="{$customlink_href}">{$customlink_label}</a> -->
						{/if}
			...
			<!-- END pag 2012-Jan-12 move Hierarchies to Top of Sidebar-->
			
			<!-- Action links for Event & Todo START-by Minnie -->
			{if $MODULE eq 'Potentials' || $MODULE eq 'HelpDesk' || $MODULE eq 'Contacts' || $MODULE eq 'Accounts' || $MODULE eq 'Leads' | $MODULE eq 'Vendors' || ($MODULE eq 'Documents' && ($ADMIN eq 'yes' || $FILE_STATUS eq '1') && $FILE_EXIST eq 'yes')}
  			<table width="100%" border="0" cellpadding="5" cellspacing="0">
				<tr><td><!-- pag 2011-Dec-02 &nbsp; --></td></tr>	
				...
				<tr><td align="left" class="genHeaderSmall">{$APP.LBL_ACTIONS}</td></tr>
					...
					<!-- tr>
						<td align="left" style="padding-left:10px;"> 
							...
							<a href="javascript:void(0);" class="webMnu" onclick="if(LTrim('{$EMAIL1}') !='' || LTrim('{$EMAIL2}') !=''){ldelim}fnvshobj(this,'sendmail_cont');sendmail('{$MODULE}',{$ID}){rdelim}else{ldelim}OpenCompose('','create'){rdelim}"><img src="{'sendmail.png'|@vtiger_imageurl:$THEME}" hspace="5" align="absmiddle"  border="0"/></a><!-- pag 2011-Dec-02 &nbsp; -->
					...
					{if $MODULE eq 'Contacts' || $MODULE eq 'Vendors' || $EVENT_PERMISSION eq 'true'}	
					<tr>
						<td align="left" style="padding-left:10px;"> 
					...
					{if $TODO_PERMISSION eq 'true' && ($MODULE eq 'Accounts' || $MODULE eq 'Leads' || $MODULE eq 'Vendors')}
					<tr>
						<td align="left" style="padding-left:10px;">
					...
					{if $MODULE eq 'Documents'}
						...
						{if $CHECK_INTEGRITY_PERMISSION eq 'yes'}
		                    ...
		                    <a href="javascript:;" onClick="checkFileIntegrityDetailView({$NOTESID});">{$MOD.LBL_CHECK_INTEGRITY}</a><!-- pag 2011-Dec-02 &nbsp; -->
			...
			<!-- pag 2012-Jan-12 THIS IS NOTE & SMS ONLY !!! -->
			{* vtlib customization: Custom links on the Detail view basic links *}
			{if $CUSTOM_LINKS && $CUSTOM_LINKS.DETAILVIEWBASIC}
				<table width="100%" border="0" cellpadding="5" cellspacing="0">
				{foreach item=CUSTOMLINK from=$CUSTOM_LINKS.DETAILVIEWBASIC}
				{if $CUSTOMLINK->linklabel neq 'LBL_SHOW_ACCOUNT_HIERARCHY' && $CUSTOMLINK->linklabel neq 'LBL_SHOW_CONTACT_HIERARCHY' && $CUSTOMLINK->linklabel neq 'LBL_SHOW_LEAD_HIERARCHY'}
				<tr>
					<td align="left" style="padding-left:10px;">
						{assign var="customlink_href" value=$CUSTOMLINK->linkurl}
						{assign var="customlink_label" value=$CUSTOMLINK->linklabel}
				...
				<!-- END pag 2012-Jan-12 THIS IS NOTE & SMS ONLY !!! -->
                <tr>
			...
			<!-- pag 2012-Jan-12 seems to do nothing ???? -->
			<!-- 
			...
			{/if}
			-->
			<!-- END pag 2012-Jan-12 seems to do nothing ???? -->
		{* END *}
                <!-- Action links END -->

                
		<!-- Tag cloud display pag 2012-Feb-24 -->
		{if $TAG_CLOUD_DISPLAY eq 'true'}
		<table border=0 cellspacing=2 cellpadding=0 width=100% style="padding-left:1px;" class="tagCloud">
		<!-- 
		<tr>
	...
	<tr>
		<td>			
			<table border=0 cellspacing=0 cellpadding=3 width=100% class="small">
				<tr>
					<td class="dvtTabCacheBottom" style="width:10px" nowrap><!-- pag 2011-Dec-02 &nbsp; --></td>
					
					<td class="dvtSelectedCellBottom" align=center nowrap>{$SINGLE_MOD|@getTranslatedString:$MODULE} {$APP.LBL_INFORMATION}</td>	
					<td class="dvtTabCacheBottom" style="width:10px"><!-- pag 2011-Dec-02 &nbsp; --></td>
					{if $SinglePane_View eq 'false' && $IS_REL_LIST neq false && $IS_REL_LIST|@count > 0}

					{*<!-- ------------------------------- Custom Modification bottom tabs pag 2012-Jan-25 --------------------------------------------------- --> *}										
							...
							<a href="index.php?action=CallRelatedList&module={$MODULE}&record={$ID}&parenttab={$CATEGORY}">{$APP.LBL_MORE} {$APP.LBL_INFORMATION}</a>
							<div 
									 id="More_Information_Modules_List" style="left: 502px; top: 76px; display: none;">
							    <table border="0" cellpadding="0" cellspacing="0" width="100%">
								{foreach key=_RELATION_ID item=_RELATED_MODULE from=$IS_REL_LIST name=mi} 
									{if $smarty.foreach.mi.index gt 3}
								    <tr>
									<td>
									    <a href="index.php?action=CallRelatedList&module={$MODULE}&record={$ID}&parenttab={$CATEGORY}&selected_header={$_RELATED_MODULE}">{$_RELATED_MODULE|@getTranslatedString:$MODULE}</a>
									</td>
								    </tr>
								    {/if}
								{/foreach}
					...
					<td class="dvtTabCacheBottom" align="right" style="width:100%">
						&nbsp;
						{if $EDIT_DUPLICATE eq 'permitted'}
						<input title="{$APP.LBL_EDIT_BUTTON_TITLE}" accessKey="{$APP.LBL_EDIT_BUTTON_KEY}" class="crmbutton small edit" onclick="DetailView.return_module.value='{$MODULE}'; DetailView.return_action.value='DetailView'; DetailView.return_id.value='{$ID}';DetailView.module.value='{$MODULE}';submitFormForAction('DetailView','EditView');" type="submit" name="Edit" value="&nbsp;{$APP.LBL_EDIT_BUTTON_LABEL}&nbsp;"><!-- pag 2011-Dec-02 &nbsp; -->
						{/if}
						{if $EDIT_DUPLICATE eq 'permitted' && $MODULE neq 'Documents'}
								<input title="{$APP.LBL_DUPLICATE_BUTTON_TITLE}" accessKey="{$APP.LBL_DUPLICATE_BUTTON_KEY}" class="crmbutton small create" onclick="DetailView.return_module.value='{$MODULE}'; DetailView.return_action.value='DetailView'; DetailView.isDuplicate.value='true';DetailView.module.value='{$MODULE}'; submitFormForAction('DetailView','EditView');" type="submit" name="Duplicate" value="{$APP.LBL_DUPLICATE_BUTTON_LABEL}"><!-- pag 2011-Dec-02 &nbsp; -->
						{/if}
						{if $DELETE eq 'permitted'}
								<input title="{$APP.LBL_DELETE_BUTTON_TITLE}" accessKey="{$APP.LBL_DELETE_BUTTON_KEY}" class="crmbutton small delete" onclick="DetailView.return_module.value='{$MODULE}'; DetailView.return_action.value='index'; {if $MODULE eq 'Accounts'} var confirmMsg = '{$APP.NTC_ACCOUNT_DELETE_CONFIRMATION}' {else} var confirmMsg = '{$APP.NTC_DELETE_CONFIRMATION}' {/if}; submitFormForActionWithConfirmation('DetailView', 'Delete', confirmMsg);" type="button" name="Delete" value="{$APP.LBL_DELETE_BUTTON_LABEL}"><!-- pag 2011-Dec-02 &nbsp; -->
						{/if}
						...
						{if $privrecord neq ''}
						<img align="absmiddle" title="{$APP.LNK_LIST_PREVIOUS}" accessKey="{$APP.LNK_LIST_PREVIOUS}" onclick="location.href='index.php?module={$MODULE}&viewtype={$VIEWTYPE}&action=DetailView&record={$privrecord}&parenttab={$CATEGORY}'" name="privrecord" value="{$APP.LNK_LIST_PREVIOUS}" src="{'rec_prev.gif'|@vtiger_imageurl:$THEME}"><!-- pag 2011-Dec-02 &nbsp; -->
						{else}
						<img align="absmiddle" title="{$APP.LNK_LIST_PREVIOUS}" src="{'rec_prev_disabled.gif'|@vtiger_imageurl:$THEME}">
						{/if}							
						{if $privrecord neq '' || $nextrecord neq ''}
						<img align="absmiddle" title="{$APP.LBL_JUMP_BTN}" accessKey="{$APP.LBL_JUMP_BTN}" onclick="var obj = this;var lhref = getListOfRecords(obj, '{$MODULE}',{$ID},'{$CATEGORY}');" name="jumpBtnIdBottom" id="jumpBtnIdBottom" src="{'rec_jump.gif'|@vtiger_imageurl:$THEME}"><!-- pag 2011-Dec-02 &nbsp; -->
						{/if}
						{if $nextrecord neq ''}
						<img align="absmiddle" title="{$APP.LNK_LIST_NEXT}" accessKey="{$APP.LNK_LIST_NEXT}" onclick="location.href='index.php?module={$MODULE}&viewtype={$VIEWTYPE}&action=DetailView&record={$nextrecord}&parenttab={$CATEGORY}'" name="nextrecord" src="{'rec_next.gif'|@vtiger_imageurl:$THEME}"><!-- pag 2011-Dec-02 &nbsp; -->
						{else}
						<img align="absmiddle" title="{$APP.LNK_LIST_NEXT}" src="{'rec_next_disabled.gif'|@vtiger_imageurl:$THEME}"><!-- pag 2011-Dec-02 &nbsp; -->
						{/if}
					</td>
