...
<tbody><tr>
	...
	<div align=center>
			{include file='SetMenu.tpl'}
				...
				<tr>
					<td width=50 rowspan=2 valign=top class="cblds-p--none"><img src="{'ico-groups.gif'|@vtiger_imageurl:$THEME}" width="48" height="48" border=0 ></td>
				...
				<tr>
					<td valign=top class="small cblds-p-v--none">{$CMOD.LBL_VIEWING} {$CMOD.LBL_PROPERTIES} &quot;{$GROUPINFO.0.groupname}`&quot; {$CMOD.LBL_GROUP_NAME} </td>
				</tr>
				</table>
