...
<tbody>
   ...
   <tr>
	...
	<td class="cellText" style="padding: 5px;">
        ...
        </span><span class="mailClientCSSButton" ><img src="{'clear_field.gif'|@vtiger_imageurl:$THEME}" alt="{$APP.LBL_CLEAR}" title="{$APP.LBL_CLEAR}" LANGUAGE=javascript onClick="document.getElementById('parent_id').value=''; document.getElementById('hidden_toid').value='';document.getElementById('parent_name').value=''; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>
        </span>
	</td>
	...
	<td class="cellText" style="padding: 5px;">
        ...
        </span><span class="mailClientCSSButton" ><img src="{'clear_field.gif'|@vtiger_imageurl:$THEME}" alt="{$APP.LBL_CLEAR}" title="{$APP.LBL_CLEAR}" LANGUAGE=javascript onClick="document.getElementById('cc_name').value='';return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>
        </span>
	</td>
	{else}
		<td>&nbsp;</td>
   ...
   {if 'bccmail'|@emails_checkFieldVisiblityPermission:'readwrite' eq '0'}   
	...
	<td class="cellText" style="padding: 5px;">
        ...
        </span><span class="mailClientCSSButton" ><img src="{'clear_field.gif'|@vtiger_imageurl:$THEME}" alt="{$APP.LBL_CLEAR}" title="{$APP.LBL_CLEAR}" LANGUAGE=javascript onClick="document.getElementById('bcc_name').value=''; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>
        </span>
	</td>
   	</tr>
   	{/if}
