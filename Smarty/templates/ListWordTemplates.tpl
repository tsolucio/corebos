...
<br>
	<div align=center>
			...
			{include file='SetMenu.tpl'}
				...
				<tr>
					<td width=50 rowspan=2 valign=top class="cblds-p_none"><img src="{'mailmarge.gif'|@vtiger_imageurl:$THEME}" alt="{$MOD.LBL_MODULE_NAME}" width="48" height="48" border=0 title="{$MOD.LBL_MODULE_NAME}"></td>
				...
				<td>
					...
					<tr>
						...
						<td width=3% class="colHeader small cblds-p-v_mediumsmall">{$UMOD.LBL_LIST_SELECT}</td>
						<td width=20% class="colHeader small cblds-p-v_mediumsmall">{$UMOD.LBL_TEMPLATE_FILE}</td>
						<td width=50% class="colHeader small cblds-p-v_mediumsmall">{$UMOD.LBL_DESCRIPTION}</td>
				        <td width=15% class="colHeader small cblds-p-v_mediumsmall">{$UMOD.LBL_MODULENAMES}</td>
				        <td width=15% class="colHeader small cblds-p-v_mediumsmall">{$UMOD.LBL_LIST_TOOLS}</td>
			          </tr>
