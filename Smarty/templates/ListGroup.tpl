							...
							<div class="slds-truncate slds-page-header">
								<div style="float: right">
									...
									<a
										...
										aria-haspopup="true"
										href="index.php?module=Settings&action=SettingsAjax&file=ImportXML&category=GROUP"
									...
									<a
										class="slds-button slds-button_icon slds-button_icon-border-filled"
										aria-haspopup="true"
										href="index.php?module=Settings&action=SettingsAjax&file=ExportXML&category=GROUP"
