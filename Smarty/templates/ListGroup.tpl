...
<tbody><tr>
	...
	<div align=center>
			{include file='SetMenu.tpl'}
				...
				<tr>
					<td width=50 rowspan=2 valign=top class="cblds-p--none"><img src="{'ico-groups.gif'|@vtiger_imageurl:$THEME}" alt="{$MOD.LBL_GROUPS}" width="48" height="48" border=0 title="{$MOD.LBL_GROUPS}"></td>
				...
				<tr>
					<td valign=top class="small cblds-p-v--none">{$MOD.LBL_GROUP_DESC}</td>
				</tr>
				</table>
				<br>
				...
				<td>
					...
					<tr>
						...
						<td class="small cblds-t-align--right" align=right>{$CMOD.LBL_TOTAL} {$GRPCNT} {$CMOD.LBL_GROUPS} </td>
					</tr>
					</table>
					...
					<tr>
						<td class="colHeader small cblds-p-v--mediumsmall" valign=top width=2%>#</td>
						<td class="colHeader small cblds-p-v--mediumsmall" valign=top width=8%>{$LIST_HEADER.0}</td>
						<td class="colHeader small cblds-p-v--mediumsmall" valign=top width=30%>{$LIST_HEADER.1}</td>
						<td class="colHeader small cblds-p-v--mediumsmall" valign=top width=60%>{$LIST_HEADER.2}</td>
					  </tr>
