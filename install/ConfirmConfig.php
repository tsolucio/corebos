...
if (isset($_REQUEST['db_hostname'])) {
	$_SESSION['config_file_info']['db_hostname'] = $db_hostname = $_REQUEST['db_hostname'];
}
if (isset($_REQUEST['db_username'])) {
	$_SESSION['config_file_info']['db_username'] = $db_username = $_REQUEST['db_username'];
}
if (isset($_REQUEST['db_password'])) {
	$_SESSION['config_file_info']['db_password'] = $db_password = $_REQUEST['db_password'];
}
if (isset($_REQUEST['db_name'])) {
	$_SESSION['config_file_info']['db_name'] = $db_name = trim($_REQUEST['db_name']);
}
if (isset($_REQUEST['db_type'])) {
	$_SESSION['config_file_info']['db_type'] = $db_type = $_REQUEST['db_type'];
}

if (isset($_REQUEST['site_URL'])) {
	$_SESSION['config_file_info']['site_URL']= $site_URL = $_REQUEST['site_URL'];
}
if (isset($_REQUEST['root_directory'])) {
	$_SESSION['config_file_info']['root_directory'] = $root_directory = $_REQUEST['root_directory'];
}

if (isset($_REQUEST['currency_name'])) {
	$_SESSION['config_file_info']['currency_name'] = $currency_name = $_REQUEST['currency_name'];
}
if (isset($_REQUEST['admin_email'])) {
	$_SESSION['config_file_info']['admin_email']= $admin_email = $_REQUEST['admin_email'];
}

if (isset($_REQUEST['currency_name'])) {
	$_SESSION['installation_info']['currency_name'] = $currency_name = $_REQUEST['currency_name'];
}
if (isset($_REQUEST['check_createdb'])) {
	$_SESSION['installation_info']['check_createdb'] = $check_createdb = $_REQUEST['check_createdb'];
}
if (isset($_REQUEST['root_user'])) {
	$_SESSION['installation_info']['root_user'] = $root_user = $_REQUEST['root_user'];
}
if (isset($_REQUEST['root_password'])) {
	$_SESSION['installation_info']['root_password'] = $root_password = $_REQUEST['root_password'];
}
if (isset($_REQUEST['admin_email'])) {
	$_SESSION['installation_info']['admin_email']= $admin_email = $_REQUEST['admin_email'];
}
if (isset($_REQUEST['admin_password'])) {
	$_SESSION['installation_info']['admin_password'] = $admin_password = $_REQUEST['admin_password'];
}
								...
								<tr>
									<td align=left class="small" width=50% style="padding-left:10px">
										<table width="100%" cellpadding="0" border="0" align=center class="level3" cellspacing="1">
											...
											<tr>
												<td noWrap width="40%">
													<?php echo $installationStrings['LBL_DATABASE'].' '.$installationStrings['LBL_UTF8_SUPPORT']; ?>
												</td>
												<td align="left" nowrap>
													<font class="dataInput">
														<?php echo $db_utf8_support ? $installationStrings['LBL_ENABLED'] : "<strong style='color:#DF0000';>{$installationStrings['LBL_NOT_ENABLED']}</strong>"; ?>
													</font>
												</td>
											</tr>
										</table>
									...
									<td align=left class="small" width=50% style="padding-left:10px">
										<table width="100%" cellpadding="0" border="0" align=center class="level3" cellspacing="1">
											...
											<tr>
												...
												<td align="left"> <em><?php echo isset($site_URL) ? $site_URL : ''; ?></em></td>
											</tr>
											<tr>
												<td width="40%"><?php echo $installationStrings['LBL_DEFAULT_CHARSET']; ?></td>
												<td align="left"> <em><?php echo isset($vt_charset) ? $vt_charset : ''; ?></em></td>
											</tr>
											<tr>
												<td width="40%"><?php echo $installationStrings['LBL_CURRENCY_NAME']; ?></td>
												<td align="left">
													<em><?php echo isset($currency_name) ? $currency_name.'('.$currencies[$currency_name][1].')' : ''; ?></em>
												</td>
											</tr>
										</table>
									</td>
									...
									<td colspan=2>
										<table width="100%" cellpadding="0" border="0" align=center class="level3" cellspacing="1">
											...
											<tr>
												...
												<td align="left" width="30%"> <em>admin</em></td>
											</tr>
											<tr>
												<td width="40%"><?php echo $installationStrings['LBL_EMAIL']; ?></td>
												<td align="left" width="30%"> <em><?php echo isset($admin_email) ? $admin_email : ''; ?></em></td>
											</tr>
										</table>
										<br>
