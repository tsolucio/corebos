									...
									<td align=left class="small" width=50% style="padding-left:10px">
										<table width="100%" cellpadding="0"  cellspacing="1" border="0" align=center class="level3">
											...
											<tr>
												...
												<?php
												if (!$db_options) {
													echo $installationStrings['LBL_NO_DATABASE_SUPPORT'];
												} elseif (count($db_options) == 1) {
													$label = reset($db_options);
													$db_type = key($db_options);
													echo '<input type="hidden" name="db_type" value="'.$db_type.'">'.$label;
												} else {
													echo '<select class="small" length=40 name="db_type">';
													foreach ($db_options as $db_option_type => $label) {
														echo '<option value="'.$db_option_type.'" '.((isset($db_type) && $db_type == $db_option_type) ? 'SELECTED': '').'>'.$label.'</option>';
													}
													echo '</select>';
												}?>
												</td>
											...
											<tr>
												...
												<td width="75%" align="left">
													<input type="text" class="small" name="db_hostname" value="<?php echo isset($db_hostname) ? $db_hostname : '';?>" />
												</td>
											</tr>
											<tr>
												<td nowrap><?php echo $installationStrings['LBL_USER_NAME']; ?> <sup><font color=red>*</font></sup></td>
												<td align="left">
													<input type="text" class="small" name="db_username" value="<?php echo isset($db_username) ? $db_username : '';?>" />
												</td>
											</tr>
											<tr>
												<td nowrap><?php echo $installationStrings['LBL_PASSWORD']; ?></td>
												<td align="left">
													<input type="password" class="small" name="db_password" value="<?php echo isset($db_password) ? $db_password : '';?>" />
												</td>
											</tr>
											<tr>
												<td nowrap><?php echo $installationStrings['LBL_DATABASE_NAME']; ?> <sup><font color=red>*</font></sup></td>
												<td align="left" width='30%'>
													<input type="text" class="small" name="db_name" value="<?php echo isset($db_name) ? $db_name : '';?>" />
												</td>
											</tr>
											<tr>
												<td colspan=2>
												...
												<?php } ?>
												&nbsp;<?php echo $installationStrings['LBL_CREATE_DATABASE'] . ' ('. $installationStrings['LBL_DROP_IF_EXISTS'] .')'; ?>
												</td>
											</tr>
											<tr id="root_user" class="hide_tab">
												<td nowrap="nowrap" width="20%">
													<?php echo $installationStrings['LBL_ROOT'].' '.$installationStrings['LBL_USER_NAME'];?> <sup><font color="red">*</font></sup>
												</td>
												<td align="left" width="30%">
													<input class="small" name="root_user" id="root_user_txtbox" value="<?php echo $root_user;?>" type="text">
												</td>
											</tr>
											<tr id="root_pass" class="hide_tab">
												<td nowrap="nowrap" width="20%">
													<?php echo $installationStrings['LBL_ROOT']. ' ' .$installationStrings['LBL_PASSWORD']; ?>
												</td>
												<td align="left" width="30%">
													<input class="small" name="root_password" value="<?php echo $root_password;?>" type="password">
												</td>
											</tr>
											<tr id="create_db_config" class="hide_tab" style="visibility: hidden;">
												...
												<td align="left" colspan=3><input class="small" type="checkbox" id="create_utf8_db" name="create_utf8_db" checked /></td>
											</tr>
											<tr>
												<td colspan=2  style="border-top:1px dotted black;">
													...
													If you are looking for demo data use the <a href="https://github.com/tsolucio/coreBOSTests">coreBOSTests database</a>
												</td>
											</tr>
									</table>
										<br>
									...
									<td align=left class="small" width=50% style="padding-left:2em;">
										...
										<table width="100%" cellpadding="0" border="0" cellspacing="1" align=center class="level3"><tbody>
											...
											<tr>
												...
												<td width="80%" align="left">
													<input class="small" type="text" name="site_URL" value="<?php echo isset($site_URL) ? $site_URL : '';?>" size="40" />
												</td>
											</tr>
											<tr>
											...
											<input type="hidden" name="root_directory" value="<?php echo isset($root_directory) ? $root_directory : '';?>" size="40" />
											<input type="hidden" name="cache_dir" value="<?php echo isset($cache_dir) ? $cache_dir : '';?>" size="40" />
										</table>
										<br>
										<!-- Admin Configuration -->
										<table width="100%" cellpadding="0" border="0" align=center class="level3" cellspacing="1" >
											...
											<tr>
												...
												<td align="left">
													<input class="small" size=25 type="password" name="admin_password" value="<?php echo isset($admin_password) ? $admin_password : 'admin';?>">
												</td>
											</tr>
											<tr>
												<td nowrap><?php echo $installationStrings['LBL_EMAIL']; ?> <sup><font color=red>*</font></sup></td>
												<td align="left">
													<input class="small" size=25 type="text" name="admin_email" value="<?php echo isset($admin_email) ? $admin_email : '';?>">
												</td>
											</tr>
										</table>
