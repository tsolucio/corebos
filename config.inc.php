...
$dbconfig['db_name'] = 'cbworkassignment';
...
$site_URL = 'http://cbdevelop.local';

// root directory path
$root_directory = '/home/guido/public_html/cbdevelop/';
...
$upload_badext = array('php', 'php3', 'php4', 'php5', 'pl', 'cgi', 'py', 'asp', 'cfm', 'js', 'vbs', 'html', 'htm', 'exe', 'bin', 'bat', 'sh', 'dll', 'phps', 'phtml',
	'xhtml', 'rb', 'msi', 'jsp', 'shtml', 'sth', 'shtm');
...
$application_unique_key = '17565f92d80ec6d79c0d50bd4ce5b052';
